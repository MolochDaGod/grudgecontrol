...
`)+`
`+p);const M=x+m+o,y=x+p+a,S=jh(i,i.VERTEX_SHADER,M),E=jh(i,i.FRAGMENT_SHADER,y);i.attachShader(_,S),i.attachShader(_,E),e.index0AttributeName!==void 0?i.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function A(C){if(s.debug.checkShaderErrors){const P=i.getProgramInfoLog(_)||"",L=i.getShaderInfoLog(S)||"",N=i.getShaderInfoLog(E)||"",z=P.trim(),O=L.trim(),G=N.trim();let K=!0,nt=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(K=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,_,S,E);else{const tt=Yh(i,S,"vertex"),ct=Yh(i,E,"fragment");Pt("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
