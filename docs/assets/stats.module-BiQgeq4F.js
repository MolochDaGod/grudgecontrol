...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:oi,depthTest:!1,depthWrite:!1})}function E0(r,e,t){const n=new Float32Array(Gi),i=new C(0,1,0);return new jn({name:"SphericalGaussianBlur",defines:{n:Gi,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${r}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:$o(),fragmentShader:`
...
`)+`
`+p);const y=x+m+o,v=x+p+a,b=au(i,i.VERTEX_SHADER,y),E=au(i,i.FRAGMENT_SHADER,v);i.attachShader(_,b),i.attachShader(_,E),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function A(P){if(r.debug.checkShaderErrors){const I=i.getProgramInfoLog(_)||"",L=i.getShaderInfoLog(b)||"",N=i.getShaderInfoLog(E)||"",z=I.trim(),B=L.trim(),G=N.trim();let Y=!0,ne=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(Y=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,b,E);else{const Q=cu(i,b,"vertex"),$=cu(i,E,"fragment");Pe("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
}`,dy=[new C(1,0,0),new C(-1,0,0),new C(0,1,0),new C(0,-1,0),new C(0,0,1),new C(0,0,-1)],fy=[new C(0,-1,0),new C(0,-1,0),new C(0,0,1),new C(0,0,-1),new C(0,-1,0),new C(0,-1,0)],_u=new we,Qs=new C,Va=new C;function py(r,e,t){let n=new Ar;const i=new Ee,s=new Ee,o=new ut,a=new qp,l=new jp,c={},h=t.maxTextureSize,u={[In]:Zt,[Zt]:In,[yn]:yn},d=new jn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ee},radius:{value:4}},vertexShader:hy,fragmentShader:uy}),f=d.clone();f.defines.HORIZONTAL_PASS=1;const g=new Mt;g.setAttribute("position",new ht(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new dt(g,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=To;let p=this.type;this.render=function(E,A,R){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||E.length===0)return;E.type===sf&&(Te("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),E.type=To);const M=r.getRenderTarget(),S=r.getActiveCubeFace(),P=r.getActiveMipmapLevel(),I=r.state;I.setBlending(oi),I.buffers.depth.getReversed()===!0?I.buffers.color.setClear(0,0,0,0):I.buffers.color.setClear(1,1,1,1),I.buffers.depth.setTest(!0),I.setScissorTest(!1);const L=p!==this.type;L&&A.traverse(function(N){N.material&&(Array.isArray(N.material)?N.material.forEach(z=>z.needsUpdate=!0):N.material.needsUpdate=!0)});for(let N=0,z=E.length;N<z;N++){const B=E[N],G=B.shadow;if(G===void 0){Te("WebGLShadowMap:",B,"has no shadow.");continue}if(G.autoUpdate===!1&&G.needsUpdate===!1)continue;i.copy(G.mapSize);const Y=G.getFrameExtents();if(i.multiply(Y),s.copy(G.mapSize),(i.x>h||i.y>h)&&(i.x>h&&(s.x=Math.floor(h/Y.x),i.x=s.x*Y.x,G.mapSize.x=s.x),i.y>h&&(s.y=Math.floor(h/Y.y),i.y=s.y*Y.y,G.mapSize.y=s.y)),G.map===null||L===!0){if(G.map!==null&&(G.map.depthTexture!==null&&(G.map.depthTexture.dispose(),G.map.depthTexture=null),G.map.dispose()),this.type===cr){if(B.isPointLight){Te("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}G.map=new Pn(i.x,i.y,{format:Ds,type:fn,minFilter:pt,magFilter:pt,generateMipmaps:!1}),G.map.texture.name=B.name+".shadowMap",G.map.depthTexture=new br(i.x,i.y,kt),G.map.depthTexture.name=B.name+".shadowMapDepth",G.map.depthTexture.format=li,G.map.depthTexture.compareFunction=null,G.map.depthTexture.minFilter=Pt,G.map.depthTexture.magFilter=Pt}else{B.isPointLight?(G.map=new Td(i.x),G.map.depthTexture=new Wp(i.x,Dn)):(G.map=new Pn(i.x,i.y),G.map.depthTexture=new br(i.x,i.y,Dn)),G.map.depthTexture.name=B.name+".shadowMap",G.map.depthTexture.format=li;const Q=r.state.buffers.depth.getReversed();this.type===To?(G.map.depthTexture.compareFunction=Q?bc:Sc,G.map.depthTexture.minFilter=pt,G.map.depthTexture.magFilter=pt):(G.map.depthTexture.compareFunction=null,G.map.depthTexture.minFilter=Pt,G.map.depthTexture.magFilter=Pt)}G.camera.updateProjectionMatrix()}const ne=G.map.isWebGLCubeRenderTarget?6:1;for(let Q=0;Q<ne;Q++){if(G.map.isWebGLCubeRenderTarget)r.setRenderTarget(G.map,Q),r.clear();else{Q===0&&(r.setRenderTarget(G.map),r.clear());const $=G.getViewport(Q);o.set(s.x*$.x,s.y*$.y,s.x*$.z,s.y*$.w),I.viewport(o)}if(B.isPointLight){const $=G.camera,de=G.matrix,_e=B.distance||$.far;_e!==$.far&&($.far=_e,$.updateProjectionMatrix()),Qs.setFromMatrixPosition(B.matrixWorld),$.position.copy(Qs),Va.copy($.position),Va.add(dy[Q]),$.up.copy(fy[Q]),$.lookAt(Va),$.updateMatrixWorld(),de.makeTranslation(-Qs.x,-Qs.y,-Qs.z),_u.multiplyMatrices($.projectionMatrix,$.matrixWorldInverse),G._frustum.setFromProjectionMatrix(_u,$.coordinateSystem,$.reversedDepth)}else G.updateMatrices(B);n=G.getFrustum(),v(A,R,G.camera,B,this.type)}G.isPointLightShadow!==!0&&this.type===cr&&x(G,R),G.needsUpdate=!1}p=this.type,m.needsUpdate=!1,r.setRenderTarget(M,S,P)};function x(E,A){const R=e.update(_);d.defines.VSM_SAMPLES!==E.blurSamples&&(d.defines.VSM_SAMPLES=E.blurSamples,f.defines.VSM_SAMPLES=E.blurSamples,d.needsUpdate=!0,f.needsUpdate=!0),E.mapPass===null&&(E.mapPass=new Pn(i.x,i.y,{format:Ds,type:fn})),d.uniforms.shadow_pass.value=E.map.depthTexture,d.uniforms.resolution.value=E.mapSize,d.uniforms.radius.value=E.radius,r.setRenderTarget(E.mapPass),r.clear(),r.renderBufferDirect(A,null,R,d,_,null),f.uniforms.shadow_pass.value=E.mapPass.texture,f.uniforms.resolution.value=E.mapSize,f.uniforms.radius.value=E.radius,r.setRenderTarget(E.map),r.clear(),r.renderBufferDirect(A,null,R,f,_,null)}function y(E,A,R,M){let S=null;const P=R.isPointLight===!0?E.customDistanceMaterial:E.customDepthMaterial;if(P!==void 0)S=P;else if(S=R.isPointLight===!0?l:a,r.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0||A.alphaToCoverage===!0){const I=S.uuid,L=A.uuid;let N=c[I];N===void 0&&(N={},c[I]=N);let z=N[L];z===void 0&&(z=S.clone(),N[L]=z,A.addEventListener("dispose",b)),S=z}if(S.visible=A.visible,S.wireframe=A.wireframe,M===cr?S.side=A.shadowSide!==null?A.shadowSide:A.side:S.side=A.shadowSide!==null?A.shadowSide:u[A.side],S.alphaMap=A.alphaMap,S.alphaTest=A.alphaToCoverage===!0?.5:A.alphaTest,S.map=A.map,S.clipShadows=A.clipShadows,S.clippingPlanes=A.clippingPlanes,S.clipIntersection=A.clipIntersection,S.displacementMap=A.displacementMap,S.displacementScale=A.displacementScale,S.displacementBias=A.displacementBias,S.wireframeLinewidth=A.wireframeLinewidth,S.linewidth=A.linewidth,R.isPointLight===!0&&S.isMeshDistanceMaterial===!0){const I=r.properties.get(S);I.light=R}return S}function v(E,A,R,M,S){if(E.visible===!1)return;if(E.layers.test(A.layers)&&(E.isMesh||E.isLine||E.isPoints)&&(E.castShadow||E.receiveShadow&&S===cr)&&(!E.frustumCulled||n.intersectsObject(E))){E.modelViewMatrix.multiplyMatrices(R.matrixWorldInverse,E.matrixWorld);const L=e.update(E),N=E.material;if(Array.isArray(N)){const z=L.groups;for(let B=0,G=z.length;B<G;B++){const Y=z[B],ne=N[Y.materialIndex];if(ne&&ne.visible){const Q=y(E,ne,M,S);E.onBeforeShadow(r,E,A,R,L,Q,Y),r.renderBufferDirect(R,null,L,Q,E,Y),E.onAfterShadow(r,E,A,R,L,Q,Y)}}}else if(N.visible){const z=y(E,N,M,S);E.onBeforeShadow(r,E,A,R,L,z,null),r.renderBufferDirect(R,null,L,z,E,null),E.onAfterShadow(r,E,A,R,L,z,null)}}const I=E.children;for(let L=0,N=I.length;L<N;L++)v(I[L],A,R,M,S)}function b(E){E.target.removeEventListener("dispose",b);for(const R in c){const M=c[R],S=E.target.uuid;S in M&&(M[S].dispose(),delete M[S])}}}const my={[al]:ll,[cl]:dl,[hl]:fl,[Cs]:ul,[ll]:al,[dl]:cl,[fl]:hl,[ul]:Cs};function gy(r,e){function t(){let F=!1;const ue=new ut;let ie=null;const fe=new ut(0,0,0,0);return{setMask:function(ee){ie!==ee&&!F&&(r.colorMask(ee,ee,ee,ee),ie=ee)},setLocked:function(ee){F=ee},setClear:function(ee,K,se,Fe,lt){lt===!0&&(ee*=Fe,K*=Fe,se*=Fe),ue.set(ee,K,se,Fe),fe.equals(ue)===!1&&(r.clearColor(ee,K,se,Fe),fe.copy(ue))},reset:function(){F=!1,ie=null,fe.set(-1,0,0,0)}}}function n(){let F=!1,ue=!1,ie=null,fe=null,ee=null;return{setReversed:function(K){if(ue!==K){const se=e.get("EXT_clip_control");K?se.clipControlEXT(se.LOWER_LEFT_EXT,se.ZERO_TO_ONE_EXT):se.clipControlEXT(se.LOWER_LEFT_EXT,se.NEGATIVE_ONE_TO_ONE_EXT),ue=K;const Fe=ee;ee=null,this.setClear(Fe)}},getReversed:function(){return ue},setTest:function(K){K?J(r.DEPTH_TEST):me(r.DEPTH_TEST)},setMask:function(K){ie!==K&&!F&&(r.depthMask(K),ie=K)},setFunc:function(K){if(ue&&(K=my[K]),fe!==K){switch(K){case al:r.depthFunc(r.NEVER);break;case ll:r.depthFunc(r.ALWAYS);break;case cl:r.depthFunc(r.LESS);break;case Cs:r.depthFunc(r.LEQUAL);break;case hl:r.depthFunc(r.EQUAL);break;case ul:r.depthFunc(r.GEQUAL);break;case dl:r.depthFunc(r.GREATER);break;case fl:r.depthFunc(r.NOTEQUAL);break;default:r.depthFunc(r.LEQUAL)}fe=K}},setLocked:function(K){F=K},setClear:function(K){ee!==K&&(ue&&(K=1-K),r.clearDepth(K),ee=K)},reset:function(){F=!1,ie=null,fe=null,ee=null,ue=!1}}}function i(){let F=!1,ue=null,ie=null,fe=null,ee=null,K=null,se=null,Fe=null,lt=null;return{setTest:function(Je){F||(Je?J(r.STENCIL_TEST):me(r.STENCIL_TEST))},setMask:function(Je){ue!==Je&&!F&&(r.stencilMask(Je),ue=Je)},setFunc:function(Je,Fn,Kn){(ie!==Je||fe!==Fn||ee!==Kn)&&(r.stencilFunc(Je,Fn,Kn),ie=Je,fe=Fn,ee=Kn)},setOp:function(Je,Fn,Kn){(K!==Je||se!==Fn||Fe!==Kn)&&(r.stencilOp(Je,Fn,Kn),K=Je,se=Fn,Fe=Kn)},setLocked:function(Je){F=Je},setClear:function(Je){lt!==Je&&(r.clearStencil(Je),lt=Je)},reset:function(){F=!1,ue=null,ie=null,fe=null,ee=null,K=null,se=null,Fe=null,lt=null}}}const s=new t,o=new n,a=new i,l=new WeakMap,c=new WeakMap;let h={},u={},d=new WeakMap,f=[],g=null,_=!1,m=null,p=null,x=null,y=null,v=null,b=null,E=null,A=new Ne(0,0,0),R=0,M=!1,S=null,P=null,I=null,L=null,N=null;const z=r.getParameter(r.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let B=!1,G=0;const Y=r.getParameter(r.VERSION);Y.indexOf("WebGL")!==-1?(G=parseFloat(/^WebGL (\d)/.exec(Y)[1]),B=G>=1):Y.indexOf("OpenGL ES")!==-1&&(G=parseFloat(/^OpenGL ES (\d)/.exec(Y)[1]),B=G>=2);let ne=null,Q={};const $=r.getParameter(r.SCISSOR_BOX),de=r.getParameter(r.VIEWPORT),_e=new ut().fromArray($),Xe=new ut().fromArray(de);function Ue(F,ue,ie,fe){const ee=new Uint8Array(4),K=r.createTexture();r.bindTexture(F,K),r.texParameteri(F,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(F,r.TEXTURE_MAG_FILTER,r.NEAREST);for(let se=0;se<ie;se++)F===r.TEXTURE_3D||F===r.TEXTURE_2D_ARRAY?r.texImage3D(ue,0,r.RGBA,1,1,fe,0,r.RGBA,r.UNSIGNED_BYTE,ee):r.texImage2D(ue+se,0,r.RGBA,1,1,0,r.RGBA,r.UNSIGNED_BYTE,ee);return K}const q={};q[r.TEXTURE_2D]=Ue(r.TEXTURE_2D,r.TEXTURE_2D,1),q[r.TEXTURE_CUBE_MAP]=Ue(r.TEXTURE_CUBE_MAP,r.TEXTURE_CUBE_MAP_POSITIVE_X,6),q[r.TEXTURE_2D_ARRAY]=Ue(r.TEXTURE_2D_ARRAY,r.TEXTURE_2D_ARRAY,1,1),q[r.TEXTURE_3D]=Ue(r.TEXTURE_3D,r.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),J(r.DEPTH_TEST),o.setFunc(Cs),ze(!1),St(Qc),J(r.CULL_FACE),$e(oi);function J(F){h[F]!==!0&&(r.enable(F),h[F]=!0)}function me(F){h[F]!==!1&&(r.disable(F),h[F]=!1)}function Be(F,ue){return u[F]!==ue?(r.bindFramebuffer(F,ue),u[F]=ue,F===r.DRAW_FRAMEBUFFER&&(u[r.FRAMEBUFFER]=ue),F===r.FRAMEBUFFER&&(u[r.DRAW_FRAMEBUFFER]=ue),!0):!1}function xe(F,ue){let ie=f,fe=!1;if(F){ie=d.get(ue),ie===void 0&&(ie=[],d.set(ue,ie));const ee=F.textures;if(ie.length!==ee.length||ie[0]!==r.COLOR_ATTACHMENT0){for(let K=0,se=ee.length;K<se;K++)ie[K]=r.COLOR_ATTACHMENT0+K;ie.length=ee.length,fe=!0}}else ie[0]!==r.BACK&&(ie[0]=r.BACK,fe=!0);fe&&r.drawBuffers(ie)}function qe(F){return g!==F?(r.useProgram(F),g=F,!0):!1}const _t={[Vi]:r.FUNC_ADD,[of]:r.FUNC_SUBTRACT,[af]:r.FUNC_REVERSE_SUBTRACT};_t[lf]=r.MIN,_t[cf]=r.MAX;const je={[hf]:r.ZERO,[uf]:r.ONE,[df]:r.SRC_COLOR,[rl]:r.SRC_ALPHA,[xf]:r.SRC_ALPHA_SATURATE,[gf]:r.DST_COLOR,[pf]:r.DST_ALPHA,[ff]:r.ONE_MINUS_SRC_COLOR,[ol]:r.ONE_MINUS_SRC_ALPHA,[_f]:r.ONE_MINUS_DST_COLOR,[mf]:r.ONE_MINUS_DST_ALPHA,[yf]:r.CONSTANT_COLOR,[vf]:r.ONE_MINUS_CONSTANT_COLOR,[Mf]:r.CONSTANT_ALPHA,[Sf]:r.ONE_MINUS_CONSTANT_ALPHA};function $e(F,ue,ie,fe,ee,K,se,Fe,lt,Je){if(F===oi){_===!0&&(me(r.BLEND),_=!1);return}if(_===!1&&(J(r.BLEND),_=!0),F!==rf){if(F!==m||Je!==M){if((p!==Vi||v!==Vi)&&(r.blendEquation(r.FUNC_ADD),p=Vi,v=Vi),Je)switch(F){case As:r.blendFuncSeparate(r.ONE,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case eh:r.blendFunc(r.ONE,r.ONE);break;case th:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case nh:r.blendFuncSeparate(r.DST_COLOR,r.ONE_MINUS_SRC_ALPHA,r.ZERO,r.ONE);break;default:Pe("WebGLState: Invalid blending: ",F);break}else switch(F){case As:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case eh:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE,r.ONE,r.ONE);break;case th:Pe("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case nh:Pe("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Pe("WebGLState: Invalid blending: ",F);break}x=null,y=null,b=null,E=null,A.set(0,0,0),R=0,m=F,M=Je}return}ee=ee||ue,K=K||ie,se=se||fe,(ue!==p||ee!==v)&&(r.blendEquationSeparate(_t[ue],_t[ee]),p=ue,v=ee),(ie!==x||fe!==y||K!==b||se!==E)&&(r.blendFuncSeparate(je[ie],je[fe],je[K],je[se]),x=ie,y=fe,b=K,E=se),(Fe.equals(A)===!1||lt!==R)&&(r.blendColor(Fe.r,Fe.g,Fe.b,lt),A.copy(Fe),R=lt),m=F,M=!1}function st(F,ue){F.side===yn?me(r.CULL_FACE):J(r.CULL_FACE);let ie=F.side===Zt;ue&&(ie=!ie),ze(ie),F.blending===As&&F.transparent===!1?$e(oi):$e(F.blending,F.blendEquation,F.blendSrc,F.blendDst,F.blendEquationAlpha,F.blendSrcAlpha,F.blendDstAlpha,F.blendColor,F.blendAlpha,F.premultipliedAlpha),o.setFunc(F.depthFunc),o.setTest(F.depthTest),o.setMask(F.depthWrite),s.setMask(F.colorWrite);const fe=F.stencilWrite;a.setTest(fe),fe&&(a.setMask(F.stencilWriteMask),a.setFunc(F.stencilFunc,F.stencilRef,F.stencilFuncMask),a.setOp(F.stencilFail,F.stencilZFail,F.stencilZPass)),bt(F.polygonOffset,F.polygonOffsetFactor,F.polygonOffsetUnits),F.alphaToCoverage===!0?J(r.SAMPLE_ALPHA_TO_COVERAGE):me(r.SAMPLE_ALPHA_TO_COVERAGE)}function ze(F){S!==F&&(F?r.frontFace(r.CW):r.frontFace(r.CCW),S=F)}function St(F){F!==tf?(J(r.CULL_FACE),F!==P&&(F===Qc?r.cullFace(r.BACK):F===nf?r.cullFace(r.FRONT):r.cullFace(r.FRONT_AND_BACK))):me(r.CULL_FACE),P=F}function U(F){F!==I&&(B&&r.lineWidth(F),I=F)}function bt(F,ue,ie){F?(J(r.POLYGON_OFFSET_FILL),(L!==ue||N!==ie)&&(r.polygonOffset(ue,ie),L=ue,N=ie)):me(r.POLYGON_OFFSET_FILL)}function Ke(F){F?J(r.SCISSOR_TEST):me(r.SCISSOR_TEST)}function at(F){F===void 0&&(F=r.TEXTURE0+z-1),ne!==F&&(r.activeTexture(F),ne=F)}function Me(F,ue,ie){ie===void 0&&(ne===null?ie=r.TEXTURE0+z-1:ie=ne);let fe=Q[ie];fe===void 0&&(fe={type:void 0,texture:void 0},Q[ie]=fe),(fe.type!==F||fe.texture!==ue)&&(ne!==ie&&(r.activeTexture(ie),ne=ie),r.bindTexture(F,ue||q[F]),fe.type=F,fe.texture=ue)}function D(){const F=Q[ne];F!==void 0&&F.type!==void 0&&(r.bindTexture(F.type,null),F.type=void 0,F.texture=void 0)}function T(){try{r.compressedTexImage2D(...arguments)}catch(F){Pe("WebGLState:",F)}}function O(){try{r.compressedTexImage3D(...arguments)}catch(F){Pe("WebGLState:",F)}}function j(){try{r.texSubImage2D(...arguments)}catch(F){Pe("WebGLState:",F)}}function Z(){try{r.texSubImage3D(...arguments)}catch(F){Pe("WebGLState:",F)}}function X(){try{r.compressedTexSubImage2D(...arguments)}catch(F){Pe("WebGLState:",F)}}function be(){try{r.compressedTexSubImage3D(...arguments)}catch(F){Pe("WebGLState:",F)}}function re(){try{r.texStorage2D(...arguments)}catch(F){Pe("WebGLState:",F)}}function ve(){try{r.texStorage3D(...arguments)}catch(F){Pe("WebGLState:",F)}}function De(){try{r.texImage2D(...arguments)}catch(F){Pe("WebGLState:",F)}}function te(){try{r.texImage3D(...arguments)}catch(F){Pe("WebGLState:",F)}}function ae(F){_e.equals(F)===!1&&(r.scissor(F.x,F.y,F.z,F.w),_e.copy(F))}function ye(F){Xe.equals(F)===!1&&(r.viewport(F.x,F.y,F.z,F.w),Xe.copy(F))}function Se(F,ue){let ie=c.get(ue);ie===void 0&&(ie=new WeakMap,c.set(ue,ie));let fe=ie.get(F);fe===void 0&&(fe=r.getUniformBlockIndex(ue,F.name),ie.set(F,fe))}function oe(F,ue){const fe=c.get(ue).get(F);l.get(ue)!==fe&&(r.uniformBlockBinding(ue,fe,F.__bindingPointIndex),l.set(ue,fe))}function Ve(){r.disable(r.BLEND),r.disable(r.CULL_FACE),r.disable(r.DEPTH_TEST),r.disable(r.POLYGON_OFFSET_FILL),r.disable(r.SCISSOR_TEST),r.disable(r.STENCIL_TEST),r.disable(r.SAMPLE_ALPHA_TO_COVERAGE),r.blendEquation(r.FUNC_ADD),r.blendFunc(r.ONE,r.ZERO),r.blendFuncSeparate(r.ONE,r.ZERO,r.ONE,r.ZERO),r.blendColor(0,0,0,0),r.colorMask(!0,!0,!0,!0),r.clearColor(0,0,0,0),r.depthMask(!0),r.depthFunc(r.LESS),o.setReversed(!1),r.clearDepth(1),r.stencilMask(4294967295),r.stencilFunc(r.ALWAYS,0,4294967295),r.stencilOp(r.KEEP,r.KEEP,r.KEEP),r.clearStencil(0),r.cullFace(r.BACK),r.frontFace(r.CCW),r.polygonOffset(0,0),r.activeTexture(r.TEXTURE0),r.bindFramebuffer(r.FRAMEBUFFER,null),r.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),r.bindFramebuffer(r.READ_FRAMEBUFFER,null),r.useProgram(null),r.lineWidth(1),r.scissor(0,0,r.canvas.width,r.canvas.height),r.viewport(0,0,r.canvas.width,r.canvas.height),h={},ne=null,Q={},u={},d=new WeakMap,f=[],g=null,_=!1,m=null,p=null,x=null,y=null,v=null,b=null,E=null,A=new Ne(0,0,0),R=0,M=!1,S=null,P=null,I=null,L=null,N=null,_e.set(0,0,r.canvas.width,r.canvas.height),Xe.set(0,0,r.canvas.width,r.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:J,disable:me,bindFramebuffer:Be,drawBuffers:xe,useProgram:qe,setBlending:$e,setMaterial:st,setFlipSided:ze,setCullFace:St,setLineWidth:U,setPolygonOffset:bt,setScissorTest:Ke,activeTexture:at,bindTexture:Me,unbindTexture:D,compressedTexImage2D:T,compressedTexImage3D:O,texImage2D:De,texImage3D:te,updateUBOMapping:Se,uniformBlockBinding:oe,texStorage2D:re,texStorage3D:ve,texSubImage2D:j,texSubImage3D:Z,compressedTexSubImage2D:X,compressedTexSubImage3D:be,scissor:ae,viewport:ye,reset:Ve}}function _y(r,e,t,n,i,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Ee,h=new WeakMap;let u;const d=new WeakMap;let f=!1;try{f=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(D,T){return f?new OffscreenCanvas(D,T):Mr("canvas")}function _(D,T,O){let j=1;const Z=Me(D);if((Z.width>O||Z.height>O)&&(j=O/Math.max(Z.width,Z.height)),j<1)if(typeof HTMLImageElement<"u"&&D instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&D instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&D instanceof ImageBitmap||typeof VideoFrame<"u"&&D instanceof VideoFrame){const X=Math.floor(j*Z.width),be=Math.floor(j*Z.height);u===void 0&&(u=g(X,be));const re=T?g(X,be):u;return re.width=X,re.height=be,re.getContext("2d").drawImage(D,0,0,X,be),Te("WebGLRenderer: Texture has been resized from ("+Z.width+"x"+Z.height+") to ("+X+"x"+be+")."),re}else return"data"in D&&Te("WebGLRenderer: Image in DataTexture is too big ("+Z.width+"x"+Z.height+")."),D;return D}function m(D){return D.generateMipmaps}function p(D){r.generateMipmap(D)}function x(D){return D.isWebGLCubeRenderTarget?r.TEXTURE_CUBE_MAP:D.isWebGL3DRenderTarget?r.TEXTURE_3D:D.isWebGLArrayRenderTarget||D.isCompressedArrayTexture?r.TEXTURE_2D_ARRAY:r.TEXTURE_2D}function y(D,T,O,j,Z=!1){if(D!==null){if(r[D]!==void 0)return r[D];Te("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+D+"'")}let X=T;if(T===r.RED&&(O===r.FLOAT&&(X=r.R32F),O===r.HALF_FLOAT&&(X=r.R16F),O===r.UNSIGNED_BYTE&&(X=r.R8)),T===r.RED_INTEGER&&(O===r.UNSIGNED_BYTE&&(X=r.R8UI),O===r.UNSIGNED_SHORT&&(X=r.R16UI),O===r.UNSIGNED_INT&&(X=r.R32UI),O===r.BYTE&&(X=r.R8I),O===r.SHORT&&(X=r.R16I),O===r.INT&&(X=r.R32I)),T===r.RG&&(O===r.FLOAT&&(X=r.RG32F),O===r.HALF_FLOAT&&(X=r.RG16F),O===r.UNSIGNED_BYTE&&(X=r.RG8)),T===r.RG_INTEGER&&(O===r.UNSIGNED_BYTE&&(X=r.RG8UI),O===r.UNSIGNED_SHORT&&(X=r.RG16UI),O===r.UNSIGNED_INT&&(X=r.RG32UI),O===r.BYTE&&(X=r.RG8I),O===r.SHORT&&(X=r.RG16I),O===r.INT&&(X=r.RG32I)),T===r.RGB_INTEGER&&(O===r.UNSIGNED_BYTE&&(X=r.RGB8UI),O===r.UNSIGNED_SHORT&&(X=r.RGB16UI),O===r.UNSIGNED_INT&&(X=r.RGB32UI),O===r.BYTE&&(X=r.RGB8I),O===r.SHORT&&(X=r.RGB16I),O===r.INT&&(X=r.RGB32I)),T===r.RGBA_INTEGER&&(O===r.UNSIGNED_BYTE&&(X=r.RGBA8UI),O===r.UNSIGNED_SHORT&&(X=r.RGBA16UI),O===r.UNSIGNED_INT&&(X=r.RGBA32UI),O===r.BYTE&&(X=r.RGBA8I),O===r.SHORT&&(X=r.RGBA16I),O===r.INT&&(X=r.RGBA32I)),T===r.RGB&&(O===r.UNSIGNED_INT_5_9_9_9_REV&&(X=r.RGB9_E5),O===r.UNSIGNED_INT_10F_11F_11F_REV&&(X=r.R11F_G11F_B10F)),T===r.RGBA){const be=Z?Bo:Ge.getTransfer(j);O===r.FLOAT&&(X=r.RGBA32F),O===r.HALF_FLOAT&&(X=r.RGBA16F),O===r.UNSIGNED_BYTE&&(X=be===et?r.SRGB8_ALPHA8:r.RGBA8),O===r.UNSIGNED_SHORT_4_4_4_4&&(X=r.RGBA4),O===r.UNSIGNED_SHORT_5_5_5_1&&(X=r.RGB5_A1)}return(X===r.R16F||X===r.R32F||X===r.RG16F||X===r.RG32F||X===r.RGBA16F||X===r.RGBA32F)&&e.get("EXT_color_buffer_float"),X}function v(D,T){let O;return D?T===null||T===Dn||T===xr?O=r.DEPTH24_STENCIL8:T===kt?O=r.DEPTH32F_STENCIL8:T===_r&&(O=r.DEPTH24_STENCIL8,Te("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):T===null||T===Dn||T===xr?O=r.DEPTH_COMPONENT24:T===kt?O=r.DEPTH_COMPONENT32F:T===_r&&(O=r.DEPTH_COMPONENT16),O}function b(D,T){return m(D)===!0||D.isFramebufferTexture&&D.minFilter!==Pt&&D.minFilter!==pt?Math.log2(Math.max(T.width,T.height))+1:D.mipmaps!==void 0&&D.mipmaps.length>0?D.mipmaps.length:D.isCompressedTexture&&Array.isArray(D.image)?T.mipmaps.length:1}function E(D){const T=D.target;T.removeEventListener("dispose",E),R(T),T.isVideoTexture&&h.delete(T)}function A(D){const T=D.target;T.removeEventListener("dispose",A),S(T)}function R(D){const T=n.get(D);if(T.__webglInit===void 0)return;const O=D.source,j=d.get(O);if(j){const Z=j[T.__cacheKey];Z.usedTimes--,Z.usedTimes===0&&M(D),Object.keys(j).length===0&&d.delete(O)}n.remove(D)}function M(D){const T=n.get(D);r.deleteTexture(T.__webglTexture);const O=D.source,j=d.get(O);delete j[T.__cacheKey],o.memory.textures--}function S(D){const T=n.get(D);if(D.depthTexture&&(D.depthTexture.dispose(),n.remove(D.depthTexture)),D.isWebGLCubeRenderTarget)for(let j=0;j<6;j++){if(Array.isArray(T.__webglFramebuffer[j]))for(let Z=0;Z<T.__webglFramebuffer[j].length;Z++)r.deleteFramebuffer(T.__webglFramebuffer[j][Z]);else r.deleteFramebuffer(T.__webglFramebuffer[j]);T.__webglDepthbuffer&&r.deleteRenderbuffer(T.__webglDepthbuffer[j])}else{if(Array.isArray(T.__webglFramebuffer))for(let j=0;j<T.__webglFramebuffer.length;j++)r.deleteFramebuffer(T.__webglFramebuffer[j]);else r.deleteFramebuffer(T.__webglFramebuffer);if(T.__webglDepthbuffer&&r.deleteRenderbuffer(T.__webglDepthbuffer),T.__webglMultisampledFramebuffer&&r.deleteFramebuffer(T.__webglMultisampledFramebuffer),T.__webglColorRenderbuffer)for(let j=0;j<T.__webglColorRenderbuffer.length;j++)T.__webglColorRenderbuffer[j]&&r.deleteRenderbuffer(T.__webglColorRenderbuffer[j]);T.__webglDepthRenderbuffer&&r.deleteRenderbuffer(T.__webglDepthRenderbuffer)}const O=D.textures;for(let j=0,Z=O.length;j<Z;j++){const X=n.get(O[j]);X.__webglTexture&&(r.deleteTexture(X.__webglTexture),o.memory.textures--),n.remove(O[j])}n.remove(D)}let P=0;function I(){P=0}function L(){const D=P;return D>=i.maxTextures&&Te("WebGLTextures: Trying to use "+D+" texture units while this GPU supports only "+i.maxTextures),P+=1,D}function N(D){const T=[];return T.push(D.wrapS),T.push(D.wrapT),T.push(D.wrapR||0),T.push(D.magFilter),T.push(D.minFilter),T.push(D.anisotropy),T.push(D.internalFormat),T.push(D.format),T.push(D.type),T.push(D.generateMipmaps),T.push(D.premultiplyAlpha),T.push(D.flipY),T.push(D.unpackAlignment),T.push(D.colorSpace),T.join()}function z(D,T){const O=n.get(D);if(D.isVideoTexture&&Ke(D),D.isRenderTargetTexture===!1&&D.isExternalTexture!==!0&&D.version>0&&O.__version!==D.version){const j=D.image;if(j===null)Te("WebGLRenderer: Texture marked for update but no image data found.");else if(j.complete===!1)Te("WebGLRenderer: Texture marked for update but image is incomplete");else{q(O,D,T);return}}else D.isExternalTexture&&(O.__webglTexture=D.sourceTexture?D.sourceTexture:null);t.bindTexture(r.TEXTURE_2D,O.__webglTexture,r.TEXTURE0+T)}function B(D,T){const O=n.get(D);if(D.isRenderTargetTexture===!1&&D.version>0&&O.__version!==D.version){q(O,D,T);return}else D.isExternalTexture&&(O.__webglTexture=D.sourceTexture?D.sourceTexture:null);t.bindTexture(r.TEXTURE_2D_ARRAY,O.__webglTexture,r.TEXTURE0+T)}function G(D,T){const O=n.get(D);if(D.isRenderTargetTexture===!1&&D.version>0&&O.__version!==D.version){q(O,D,T);return}t.bindTexture(r.TEXTURE_3D,O.__webglTexture,r.TEXTURE0+T)}function Y(D,T){const O=n.get(D);if(D.isCubeDepthTexture!==!0&&D.version>0&&O.__version!==D.version){J(O,D,T);return}t.bindTexture(r.TEXTURE_CUBE_MAP,O.__webglTexture,r.TEXTURE0+T)}const ne={[Is]:r.REPEAT,[dn]:r.CLAMP_TO_EDGE,[Uo]:r.MIRRORED_REPEAT},Q={[Pt]:r.NEAREST,[ad]:r.NEAREST_MIPMAP_NEAREST,[hr]:r.NEAREST_MIPMAP_LINEAR,[pt]:r.LINEAR,[Eo]:r.LINEAR_MIPMAP_NEAREST,[Gn]:r.LINEAR_MIPMAP_LINEAR},$={[If]:r.NEVER,[Ff]:r.ALWAYS,[Df]:r.LESS,[Sc]:r.LEQUAL,[Lf]:r.EQUAL,[bc]:r.GEQUAL,[Nf]:r.GREATER,[Uf]:r.NOTEQUAL};function de(D,T){if(T.type===kt&&e.has("OES_texture_float_linear")===!1&&(T.magFilter===pt||T.magFilter===Eo||T.magFilter===hr||T.magFilter===Gn||T.minFilter===pt||T.minFilter===Eo||T.minFilter===hr||T.minFilter===Gn)&&Te("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),r.texParameteri(D,r.TEXTURE_WRAP_S,ne[T.wrapS]),r.texParameteri(D,r.TEXTURE_WRAP_T,ne[T.wrapT]),(D===r.TEXTURE_3D||D===r.TEXTURE_2D_ARRAY)&&r.texParameteri(D,r.TEXTURE_WRAP_R,ne[T.wrapR]),r.texParameteri(D,r.TEXTURE_MAG_FILTER,Q[T.magFilter]),r.texParameteri(D,r.TEXTURE_MIN_FILTER,Q[T.minFilter]),T.compareFunction&&(r.texParameteri(D,r.TEXTURE_COMPARE_MODE,r.COMPARE_REF_TO_TEXTURE),r.texParameteri(D,r.TEXTURE_COMPARE_FUNC,$[T.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(T.magFilter===Pt||T.minFilter!==hr&&T.minFilter!==Gn||T.type===kt&&e.has("OES_texture_float_linear")===!1)return;if(T.anisotropy>1||n.get(T).__currentAnisotropy){const O=e.get("EXT_texture_filter_anisotropic");r.texParameterf(D,O.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(T.anisotropy,i.getMaxAnisotropy())),n.get(T).__currentAnisotropy=T.anisotropy}}}function _e(D,T){let O=!1;D.__webglInit===void 0&&(D.__webglInit=!0,T.addEventListener("dispose",E));const j=T.source;let Z=d.get(j);Z===void 0&&(Z={},d.set(j,Z));const X=N(T);if(X!==D.__cacheKey){Z[X]===void 0&&(Z[X]={texture:r.createTexture(),usedTimes:0},o.memory.textures++,O=!0),Z[X].usedTimes++;const be=Z[D.__cacheKey];be!==void 0&&(Z[D.__cacheKey].usedTimes--,be.usedTimes===0&&M(T)),D.__cacheKey=X,D.__webglTexture=Z[X].texture}return O}function Xe(D,T,O){return Math.floor(Math.floor(D/O)/T)}function Ue(D,T,O,j){const X=D.updateRanges;if(X.length===0)t.texSubImage2D(r.TEXTURE_2D,0,0,0,T.width,T.height,O,j,T.data);else{X.sort((te,ae)=>te.start-ae.start);let be=0;for(let te=1;te<X.length;te++){const ae=X[be],ye=X[te],Se=ae.start+ae.count,oe=Xe(ye.start,T.width,4),Ve=Xe(ae.start,T.width,4);ye.start<=Se+1&&oe===Ve&&Xe(ye.start+ye.count-1,T.width,4)===oe?ae.count=Math.max(ae.count,ye.start+ye.count-ae.start):(++be,X[be]=ye)}X.length=be+1;const re=r.getParameter(r.UNPACK_ROW_LENGTH),ve=r.getParameter(r.UNPACK_SKIP_PIXELS),De=r.getParameter(r.UNPACK_SKIP_ROWS);r.pixelStorei(r.UNPACK_ROW_LENGTH,T.width);for(let te=0,ae=X.length;te<ae;te++){const ye=X[te],Se=Math.floor(ye.start/4),oe=Math.ceil(ye.count/4),Ve=Se%T.width,F=Math.floor(Se/T.width),ue=oe,ie=1;r.pixelStorei(r.UNPACK_SKIP_PIXELS,Ve),r.pixelStorei(r.UNPACK_SKIP_ROWS,F),t.texSubImage2D(r.TEXTURE_2D,0,Ve,F,ue,ie,O,j,T.data)}D.clearUpdateRanges(),r.pixelStorei(r.UNPACK_ROW_LENGTH,re),r.pixelStorei(r.UNPACK_SKIP_PIXELS,ve),r.pixelStorei(r.UNPACK_SKIP_ROWS,De)}}function q(D,T,O){let j=r.TEXTURE_2D;(T.isDataArrayTexture||T.isCompressedArrayTexture)&&(j=r.TEXTURE_2D_ARRAY),T.isData3DTexture&&(j=r.TEXTURE_3D);const Z=_e(D,T),X=T.source;t.bindTexture(j,D.__webglTexture,r.TEXTURE0+O);const be=n.get(X);if(X.version!==be.__version||Z===!0){t.activeTexture(r.TEXTURE0+O);const re=Ge.getPrimaries(Ge.workingColorSpace),ve=T.colorSpace===yi?null:Ge.getPrimaries(T.colorSpace),De=T.colorSpace===yi||re===ve?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,T.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,T.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,T.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,De);let te=_(T.image,!1,i.maxTextureSize);te=at(T,te);const ae=s.convert(T.format,T.colorSpace),ye=s.convert(T.type);let Se=y(T.internalFormat,ae,ye,T.colorSpace,T.isVideoTexture);de(j,T);let oe;const Ve=T.mipmaps,F=T.isVideoTexture!==!0,ue=be.__version===void 0||Z===!0,ie=X.dataReady,fe=b(T,te);if(T.isDepthTexture)Se=v(T.format===Wi,T.type),ue&&(F?t.texStorage2D(r.TEXTURE_2D,1,Se,te.width,te.height):t.texImage2D(r.TEXTURE_2D,0,Se,te.width,te.height,0,ae,ye,null));else if(T.isDataTexture)if(Ve.length>0){F&&ue&&t.texStorage2D(r.TEXTURE_2D,fe,Se,Ve[0].width,Ve[0].height);for(let ee=0,K=Ve.length;ee<K;ee++)oe=Ve[ee],F?ie&&t.texSubImage2D(r.TEXTURE_2D,ee,0,0,oe.width,oe.height,ae,ye,oe.data):t.texImage2D(r.TEXTURE_2D,ee,Se,oe.width,oe.height,0,ae,ye,oe.data);T.generateMipmaps=!1}else F?(ue&&t.texStorage2D(r.TEXTURE_2D,fe,Se,te.width,te.height),ie&&Ue(T,te,ae,ye)):t.texImage2D(r.TEXTURE_2D,0,Se,te.width,te.height,0,ae,ye,te.data);else if(T.isCompressedTexture)if(T.isCompressedArrayTexture){F&&ue&&t.texStorage3D(r.TEXTURE_2D_ARRAY,fe,Se,Ve[0].width,Ve[0].height,te.depth);for(let ee=0,K=Ve.length;ee<K;ee++)if(oe=Ve[ee],T.format!==rn)if(ae!==null)if(F){if(ie)if(T.layerUpdates.size>0){const se=ec(oe.width,oe.height,T.format,T.type);for(const Fe of T.layerUpdates){const lt=oe.data.subarray(Fe*se/oe.data.BYTES_PER_ELEMENT,(Fe+1)*se/oe.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,ee,0,0,Fe,oe.width,oe.height,1,ae,lt)}T.clearLayerUpdates()}else t.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,ee,0,0,0,oe.width,oe.height,te.depth,ae,oe.data)}else t.compressedTexImage3D(r.TEXTURE_2D_ARRAY,ee,Se,oe.width,oe.height,te.depth,0,oe.data,0,0);else Te("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else F?ie&&t.texSubImage3D(r.TEXTURE_2D_ARRAY,ee,0,0,0,oe.width,oe.height,te.depth,ae,ye,oe.data):t.texImage3D(r.TEXTURE_2D_ARRAY,ee,Se,oe.width,oe.height,te.depth,0,ae,ye,oe.data)}else{F&&ue&&t.texStorage2D(r.TEXTURE_2D,fe,Se,Ve[0].width,Ve[0].height);for(let ee=0,K=Ve.length;ee<K;ee++)oe=Ve[ee],T.format!==rn?ae!==null?F?ie&&t.compressedTexSubImage2D(r.TEXTURE_2D,ee,0,0,oe.width,oe.height,ae,oe.data):t.compressedTexImage2D(r.TEXTURE_2D,ee,Se,oe.width,oe.height,0,oe.data):Te("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):F?ie&&t.texSubImage2D(r.TEXTURE_2D,ee,0,0,oe.width,oe.height,ae,ye,oe.data):t.texImage2D(r.TEXTURE_2D,ee,Se,oe.width,oe.height,0,ae,ye,oe.data)}else if(T.isDataArrayTexture)if(F){if(ue&&t.texStorage3D(r.TEXTURE_2D_ARRAY,fe,Se,te.width,te.height,te.depth),ie)if(T.layerUpdates.size>0){const ee=ec(te.width,te.height,T.format,T.type);for(const K of T.layerUpdates){const se=te.data.subarray(K*ee/te.data.BYTES_PER_ELEMENT,(K+1)*ee/te.data.BYTES_PER_ELEMENT);t.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,K,te.width,te.height,1,ae,ye,se)}T.clearLayerUpdates()}else t.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,0,te.width,te.height,te.depth,ae,ye,te.data)}else t.texImage3D(r.TEXTURE_2D_ARRAY,0,Se,te.width,te.height,te.depth,0,ae,ye,te.data);else if(T.isData3DTexture)F?(ue&&t.texStorage3D(r.TEXTURE_3D,fe,Se,te.width,te.height,te.depth),ie&&t.texSubImage3D(r.TEXTURE_3D,0,0,0,0,te.width,te.height,te.depth,ae,ye,te.data)):t.texImage3D(r.TEXTURE_3D,0,Se,te.width,te.height,te.depth,0,ae,ye,te.data);else if(T.isFramebufferTexture){if(ue)if(F)t.texStorage2D(r.TEXTURE_2D,fe,Se,te.width,te.height);else{let ee=te.width,K=te.height;for(let se=0;se<fe;se++)t.texImage2D(r.TEXTURE_2D,se,Se,ee,K,0,ae,ye,null),ee>>=1,K>>=1}}else if(Ve.length>0){if(F&&ue){const ee=Me(Ve[0]);t.texStorage2D(r.TEXTURE_2D,fe,Se,ee.width,ee.height)}for(let ee=0,K=Ve.length;ee<K;ee++)oe=Ve[ee],F?ie&&t.texSubImage2D(r.TEXTURE_2D,ee,0,0,ae,ye,oe):t.texImage2D(r.TEXTURE_2D,ee,Se,ae,ye,oe);T.generateMipmaps=!1}else if(F){if(ue){const ee=Me(te);t.texStorage2D(r.TEXTURE_2D,fe,Se,ee.width,ee.height)}ie&&t.texSubImage2D(r.TEXTURE_2D,0,0,0,ae,ye,te)}else t.texImage2D(r.TEXTURE_2D,0,Se,ae,ye,te);m(T)&&p(j),be.__version=X.version,T.onUpdate&&T.onUpdate(T)}D.__version=T.version}function J(D,T,O){if(T.image.length!==6)return;const j=_e(D,T),Z=T.source;t.bindTexture(r.TEXTURE_CUBE_MAP,D.__webglTexture,r.TEXTURE0+O);const X=n.get(Z);if(Z.version!==X.__version||j===!0){t.activeTexture(r.TEXTURE0+O);const be=Ge.getPrimaries(Ge.workingColorSpace),re=T.colorSpace===yi?null:Ge.getPrimaries(T.colorSpace),ve=T.colorSpace===yi||be===re?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,T.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,T.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,T.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,ve);const De=T.isCompressedTexture||T.image[0].isCompressedTexture,te=T.image[0]&&T.image[0].isDataTexture,ae=[];for(let K=0;K<6;K++)!De&&!te?ae[K]=_(T.image[K],!0,i.maxCubemapSize):ae[K]=te?T.image[K].image:T.image[K],ae[K]=at(T,ae[K]);const ye=ae[0],Se=s.convert(T.format,T.colorSpace),oe=s.convert(T.type),Ve=y(T.internalFormat,Se,oe,T.colorSpace),F=T.isVideoTexture!==!0,ue=X.__version===void 0||j===!0,ie=Z.dataReady;let fe=b(T,ye);de(r.TEXTURE_CUBE_MAP,T);let ee;if(De){F&&ue&&t.texStorage2D(r.TEXTURE_CUBE_MAP,fe,Ve,ye.width,ye.height);for(let K=0;K<6;K++){ee=ae[K].mipmaps;for(let se=0;se<ee.length;se++){const Fe=ee[se];T.format!==rn?Se!==null?F?ie&&t.compressedTexSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,se,0,0,Fe.width,Fe.height,Se,Fe.data):t.compressedTexImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,se,Ve,Fe.width,Fe.height,0,Fe.data):Te("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):F?ie&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,se,0,0,Fe.width,Fe.height,Se,oe,Fe.data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,se,Ve,Fe.width,Fe.height,0,Se,oe,Fe.data)}}}else{if(ee=T.mipmaps,F&&ue){ee.length>0&&fe++;const K=Me(ae[0]);t.texStorage2D(r.TEXTURE_CUBE_MAP,fe,Ve,K.width,K.height)}for(let K=0;K<6;K++)if(te){F?ie&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,ae[K].width,ae[K].height,Se,oe,ae[K].data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,Ve,ae[K].width,ae[K].height,0,Se,oe,ae[K].data);for(let se=0;se<ee.length;se++){const lt=ee[se].image[K].image;F?ie&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,se+1,0,0,lt.width,lt.height,Se,oe,lt.data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,se+1,Ve,lt.width,lt.height,0,Se,oe,lt.data)}}else{F?ie&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,0,0,Se,oe,ae[K]):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,0,Ve,Se,oe,ae[K]);for(let se=0;se<ee.length;se++){const Fe=ee[se];F?ie&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,se+1,0,0,Se,oe,Fe.image[K]):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+K,se+1,Ve,Se,oe,Fe.image[K])}}}m(T)&&p(r.TEXTURE_CUBE_MAP),X.__version=Z.version,T.onUpdate&&T.onUpdate(T)}D.__version=T.version}function me(D,T,O,j,Z,X){const be=s.convert(O.format,O.colorSpace),re=s.convert(O.type),ve=y(O.internalFormat,be,re,O.colorSpace),De=n.get(T),te=n.get(O);if(te.__renderTarget=T,!De.__hasExternalTextures){const ae=Math.max(1,T.width>>X),ye=Math.max(1,T.height>>X);Z===r.TEXTURE_3D||Z===r.TEXTURE_2D_ARRAY?t.texImage3D(Z,X,ve,ae,ye,T.depth,0,be,re,null):t.texImage2D(Z,X,ve,ae,ye,0,be,re,null)}t.bindFramebuffer(r.FRAMEBUFFER,D),bt(T)?a.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,j,Z,te.__webglTexture,0,U(T)):(Z===r.TEXTURE_2D||Z>=r.TEXTURE_CUBE_MAP_POSITIVE_X&&Z<=r.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&r.framebufferTexture2D(r.FRAMEBUFFER,j,Z,te.__webglTexture,X),t.bindFramebuffer(r.FRAMEBUFFER,null)}function Be(D,T,O){if(r.bindRenderbuffer(r.RENDERBUFFER,D),T.depthBuffer){const j=T.depthTexture,Z=j&&j.isDepthTexture?j.type:null,X=v(T.stencilBuffer,Z),be=T.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;bt(T)?a.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,U(T),X,T.width,T.height):O?r.renderbufferStorageMultisample(r.RENDERBUFFER,U(T),X,T.width,T.height):r.renderbufferStorage(r.RENDERBUFFER,X,T.width,T.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,be,r.RENDERBUFFER,D)}else{const j=T.textures;for(let Z=0;Z<j.length;Z++){const X=j[Z],be=s.convert(X.format,X.colorSpace),re=s.convert(X.type),ve=y(X.internalFormat,be,re,X.colorSpace);bt(T)?a.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,U(T),ve,T.width,T.height):O?r.renderbufferStorageMultisample(r.RENDERBUFFER,U(T),ve,T.width,T.height):r.renderbufferStorage(r.RENDERBUFFER,ve,T.width,T.height)}}r.bindRenderbuffer(r.RENDERBUFFER,null)}function xe(D,T,O){const j=T.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(r.FRAMEBUFFER,D),!(T.depthTexture&&T.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const Z=n.get(T.depthTexture);if(Z.__renderTarget=T,(!Z.__webglTexture||T.depthTexture.image.width!==T.width||T.depthTexture.image.height!==T.height)&&(T.depthTexture.image.width=T.width,T.depthTexture.image.height=T.height,T.depthTexture.needsUpdate=!0),j){if(Z.__webglInit===void 0&&(Z.__webglInit=!0,T.depthTexture.addEventListener("dispose",E)),Z.__webglTexture===void 0){Z.__webglTexture=r.createTexture(),t.bindTexture(r.TEXTURE_CUBE_MAP,Z.__webglTexture),de(r.TEXTURE_CUBE_MAP,T.depthTexture);const De=s.convert(T.depthTexture.format),te=s.convert(T.depthTexture.type);let ae;T.depthTexture.format===li?ae=r.DEPTH_COMPONENT24:T.depthTexture.format===Wi&&(ae=r.DEPTH24_STENCIL8);for(let ye=0;ye<6;ye++)r.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+ye,0,ae,T.width,T.height,0,De,te,null)}}else z(T.depthTexture,0);const X=Z.__webglTexture,be=U(T),re=j?r.TEXTURE_CUBE_MAP_POSITIVE_X+O:r.TEXTURE_2D,ve=T.depthTexture.format===Wi?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;if(T.depthTexture.format===li)bt(T)?a.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,ve,re,X,0,be):r.framebufferTexture2D(r.FRAMEBUFFER,ve,re,X,0);else if(T.depthTexture.format===Wi)bt(T)?a.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,ve,re,X,0,be):r.framebufferTexture2D(r.FRAMEBUFFER,ve,re,X,0);else throw new Error("Unknown depthTexture format")}function qe(D){const T=n.get(D),O=D.isWebGLCubeRenderTarget===!0;if(T.__boundDepthTexture!==D.depthTexture){const j=D.depthTexture;if(T.__depthDisposeCallback&&T.__depthDisposeCallback(),j){const Z=()=>{delete T.__boundDepthTexture,delete T.__depthDisposeCallback,j.removeEventListener("dispose",Z)};j.addEventListener("dispose",Z),T.__depthDisposeCallback=Z}T.__boundDepthTexture=j}if(D.depthTexture&&!T.__autoAllocateDepthBuffer)if(O)for(let j=0;j<6;j++)xe(T.__webglFramebuffer[j],D,j);else{const j=D.texture.mipmaps;j&&j.length>0?xe(T.__webglFramebuffer[0],D,0):xe(T.__webglFramebuffer,D,0)}else if(O){T.__webglDepthbuffer=[];for(let j=0;j<6;j++)if(t.bindFramebuffer(r.FRAMEBUFFER,T.__webglFramebuffer[j]),T.__webglDepthbuffer[j]===void 0)T.__webglDepthbuffer[j]=r.createRenderbuffer(),Be(T.__webglDepthbuffer[j],D,!1);else{const Z=D.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,X=T.__webglDepthbuffer[j];r.bindRenderbuffer(r.RENDERBUFFER,X),r.framebufferRenderbuffer(r.FRAMEBUFFER,Z,r.RENDERBUFFER,X)}}else{const j=D.texture.mipmaps;if(j&&j.length>0?t.bindFramebuffer(r.FRAMEBUFFER,T.__webglFramebuffer[0]):t.bindFramebuffer(r.FRAMEBUFFER,T.__webglFramebuffer),T.__webglDepthbuffer===void 0)T.__webglDepthbuffer=r.createRenderbuffer(),Be(T.__webglDepthbuffer,D,!1);else{const Z=D.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,X=T.__webglDepthbuffer;r.bindRenderbuffer(r.RENDERBUFFER,X),r.framebufferRenderbuffer(r.FRAMEBUFFER,Z,r.RENDERBUFFER,X)}}t.bindFramebuffer(r.FRAMEBUFFER,null)}function _t(D,T,O){const j=n.get(D);T!==void 0&&me(j.__webglFramebuffer,D,D.texture,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,0),O!==void 0&&qe(D)}function je(D){const T=D.texture,O=n.get(D),j=n.get(T);D.addEventListener("dispose",A);const Z=D.textures,X=D.isWebGLCubeRenderTarget===!0,be=Z.length>1;if(be||(j.__webglTexture===void 0&&(j.__webglTexture=r.createTexture()),j.__version=T.version,o.memory.textures++),X){O.__webglFramebuffer=[];for(let re=0;re<6;re++)if(T.mipmaps&&T.mipmaps.length>0){O.__webglFramebuffer[re]=[];for(let ve=0;ve<T.mipmaps.length;ve++)O.__webglFramebuffer[re][ve]=r.createFramebuffer()}else O.__webglFramebuffer[re]=r.createFramebuffer()}else{if(T.mipmaps&&T.mipmaps.length>0){O.__webglFramebuffer=[];for(let re=0;re<T.mipmaps.length;re++)O.__webglFramebuffer[re]=r.createFramebuffer()}else O.__webglFramebuffer=r.createFramebuffer();if(be)for(let re=0,ve=Z.length;re<ve;re++){const De=n.get(Z[re]);De.__webglTexture===void 0&&(De.__webglTexture=r.createTexture(),o.memory.textures++)}if(D.samples>0&&bt(D)===!1){O.__webglMultisampledFramebuffer=r.createFramebuffer(),O.__webglColorRenderbuffer=[],t.bindFramebuffer(r.FRAMEBUFFER,O.__webglMultisampledFramebuffer);for(let re=0;re<Z.length;re++){const ve=Z[re];O.__webglColorRenderbuffer[re]=r.createRenderbuffer(),r.bindRenderbuffer(r.RENDERBUFFER,O.__webglColorRenderbuffer[re]);const De=s.convert(ve.format,ve.colorSpace),te=s.convert(ve.type),ae=y(ve.internalFormat,De,te,ve.colorSpace,D.isXRRenderTarget===!0),ye=U(D);r.renderbufferStorageMultisample(r.RENDERBUFFER,ye,ae,D.width,D.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+re,r.RENDERBUFFER,O.__webglColorRenderbuffer[re])}r.bindRenderbuffer(r.RENDERBUFFER,null),D.depthBuffer&&(O.__webglDepthRenderbuffer=r.createRenderbuffer(),Be(O.__webglDepthRenderbuffer,D,!0)),t.bindFramebuffer(r.FRAMEBUFFER,null)}}if(X){t.bindTexture(r.TEXTURE_CUBE_MAP,j.__webglTexture),de(r.TEXTURE_CUBE_MAP,T);for(let re=0;re<6;re++)if(T.mipmaps&&T.mipmaps.length>0)for(let ve=0;ve<T.mipmaps.length;ve++)me(O.__webglFramebuffer[re][ve],D,T,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+re,ve);else me(O.__webglFramebuffer[re],D,T,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+re,0);m(T)&&p(r.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(be){for(let re=0,ve=Z.length;re<ve;re++){const De=Z[re],te=n.get(De);let ae=r.TEXTURE_2D;(D.isWebGL3DRenderTarget||D.isWebGLArrayRenderTarget)&&(ae=D.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),t.bindTexture(ae,te.__webglTexture),de(ae,De),me(O.__webglFramebuffer,D,De,r.COLOR_ATTACHMENT0+re,ae,0),m(De)&&p(ae)}t.unbindTexture()}else{let re=r.TEXTURE_2D;if((D.isWebGL3DRenderTarget||D.isWebGLArrayRenderTarget)&&(re=D.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),t.bindTexture(re,j.__webglTexture),de(re,T),T.mipmaps&&T.mipmaps.length>0)for(let ve=0;ve<T.mipmaps.length;ve++)me(O.__webglFramebuffer[ve],D,T,r.COLOR_ATTACHMENT0,re,ve);else me(O.__webglFramebuffer,D,T,r.COLOR_ATTACHMENT0,re,0);m(T)&&p(re),t.unbindTexture()}D.depthBuffer&&qe(D)}function $e(D){const T=D.textures;for(let O=0,j=T.length;O<j;O++){const Z=T[O];if(m(Z)){const X=x(D),be=n.get(Z).__webglTexture;t.bindTexture(X,be),p(X),t.unbindTexture()}}}const st=[],ze=[];function St(D){if(D.samples>0){if(bt(D)===!1){const T=D.textures,O=D.width,j=D.height;let Z=r.COLOR_BUFFER_BIT;const X=D.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,be=n.get(D),re=T.length>1;if(re)for(let De=0;De<T.length;De++)t.bindFramebuffer(r.FRAMEBUFFER,be.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+De,r.RENDERBUFFER,null),t.bindFramebuffer(r.FRAMEBUFFER,be.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+De,r.TEXTURE_2D,null,0);t.bindFramebuffer(r.READ_FRAMEBUFFER,be.__webglMultisampledFramebuffer);const ve=D.texture.mipmaps;ve&&ve.length>0?t.bindFramebuffer(r.DRAW_FRAMEBUFFER,be.__webglFramebuffer[0]):t.bindFramebuffer(r.DRAW_FRAMEBUFFER,be.__webglFramebuffer);for(let De=0;De<T.length;De++){if(D.resolveDepthBuffer&&(D.depthBuffer&&(Z|=r.DEPTH_BUFFER_BIT),D.stencilBuffer&&D.resolveStencilBuffer&&(Z|=r.STENCIL_BUFFER_BIT)),re){r.framebufferRenderbuffer(r.READ_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.RENDERBUFFER,be.__webglColorRenderbuffer[De]);const te=n.get(T[De]).__webglTexture;r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,te,0)}r.blitFramebuffer(0,0,O,j,0,0,O,j,Z,r.NEAREST),l===!0&&(st.length=0,ze.length=0,st.push(r.COLOR_ATTACHMENT0+De),D.depthBuffer&&D.resolveDepthBuffer===!1&&(st.push(X),ze.push(X),r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,ze)),r.invalidateFramebuffer(r.READ_FRAMEBUFFER,st))}if(t.bindFramebuffer(r.READ_FRAMEBUFFER,null),t.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),re)for(let De=0;De<T.length;De++){t.bindFramebuffer(r.FRAMEBUFFER,be.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+De,r.RENDERBUFFER,be.__webglColorRenderbuffer[De]);const te=n.get(T[De]).__webglTexture;t.bindFramebuffer(r.FRAMEBUFFER,be.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+De,r.TEXTURE_2D,te,0)}t.bindFramebuffer(r.DRAW_FRAMEBUFFER,be.__webglMultisampledFramebuffer)}else if(D.depthBuffer&&D.resolveDepthBuffer===!1&&l){const T=D.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,[T])}}}function U(D){return Math.min(i.maxSamples,D.samples)}function bt(D){const T=n.get(D);return D.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&T.__useRenderToTexture!==!1}function Ke(D){const T=o.render.frame;h.get(D)!==T&&(h.set(D,T),D.update())}function at(D,T){const O=D.colorSpace,j=D.format,Z=D.type;return D.isCompressedTexture===!0||D.isVideoTexture===!0||O!==zt&&O!==yi&&(Ge.getTransfer(O)===et?(j!==rn||Z!==un)&&Te("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Pe("WebGLTextures: Unsupported texture color space:",O)),T}function Me(D){return typeof HTMLImageElement<"u"&&D instanceof HTMLImageElement?(c.width=D.naturalWidth||D.width,c.height=D.naturalHeight||D.height):typeof VideoFrame<"u"&&D instanceof VideoFrame?(c.width=D.displayWidth,c.height=D.displayHeight):(c.width=D.width,c.height=D.height),c}this.allocateTextureUnit=L,this.resetTextureUnits=I,this.setTexture2D=z,this.setTexture2DArray=B,this.setTexture3D=G,this.setTextureCube=Y,this.rebindTextures=_t,this.setupRenderTarget=je,this.updateRenderTargetMipmap=$e,this.updateMultisampleRenderTarget=St,this.setupDepthRenderbuffer=qe,this.setupFrameBufferTexture=me,this.useMultisampledRTT=bt,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function xy(r,e){function t(n,i=yi){let s;const o=Ge.getTransfer(i);if(n===un)return r.UNSIGNED_BYTE;if(n===gc)return r.UNSIGNED_SHORT_4_4_4_4;if(n===_c)return r.UNSIGNED_SHORT_5_5_5_1;if(n===hd)return r.UNSIGNED_INT_5_9_9_9_REV;if(n===ud)return r.UNSIGNED_INT_10F_11F_11F_REV;if(n===ld)return r.BYTE;if(n===cd)return r.SHORT;if(n===_r)return r.UNSIGNED_SHORT;if(n===mc)return r.INT;if(n===Dn)return r.UNSIGNED_INT;if(n===kt)return r.FLOAT;if(n===fn)return r.HALF_FLOAT;if(n===dd)return r.ALPHA;if(n===fd)return r.RGB;if(n===rn)return r.RGBA;if(n===li)return r.DEPTH_COMPONENT;if(n===Wi)return r.DEPTH_STENCIL;if(n===xc)return r.RED;if(n===Wo)return r.RED_INTEGER;if(n===Ds)return r.RG;if(n===yc)return r.RG_INTEGER;if(n===vc)return r.RGBA_INTEGER;if(n===Ao||n===wo||n===Ro||n===Co)if(o===et)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===Ao)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===wo)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Ro)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Co)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===Ao)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===wo)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Ro)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Co)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===gl||n===_l||n===xl||n===yl)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===gl)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===_l)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===xl)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===yl)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===vl||n===Ml||n===Sl||n===bl||n===Tl||n===El||n===Al)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===vl||n===Ml)return o===et?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===Sl)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(n===bl)return s.COMPRESSED_R11_EAC;if(n===Tl)return s.COMPRESSED_SIGNED_R11_EAC;if(n===El)return s.COMPRESSED_RG11_EAC;if(n===Al)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===wl||n===Rl||n===Cl||n===Pl||n===Il||n===Dl||n===Ll||n===Nl||n===Ul||n===Fl||n===Bl||n===Ol||n===kl||n===zl)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===wl)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Rl)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Cl)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Pl)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Il)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Dl)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Ll)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Nl)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Ul)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Fl)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Bl)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Ol)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===kl)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===zl)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Vl||n===Hl||n===Gl)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===Vl)return o===et?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Hl)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Gl)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Wl||n===Xl||n===ql||n===jl)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===Wl)return s.COMPRESSED_RED_RGTC1_EXT;if(n===Xl)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===ql)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===jl)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===xr?r.UNSIGNED_INT_24_8:r[n]!==void 0?r[n]:null}return{convert:t}}const yy=`
void main() {
