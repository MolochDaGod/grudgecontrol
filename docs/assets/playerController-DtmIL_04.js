...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ri,depthTest:!1,depthWrite:!1})}function Oh(){return new Xn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ho(),fragmentShader:`
		...
		`,blending:ri,depthTest:!1,depthWrite:!1})}function kh(){return new Xn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ho(),fragmentShader:`
...
#define LOW_PRECISION`),t}const Cx={[yo]:"SHADOWMAP_TYPE_PCF",[rr]:"SHADOWMAP_TYPE_VSM"};function Px(s){return Cx[s.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const Ix={[Si]:"ENVMAP_TYPE_CUBE",[ws]:"ENVMAP_TYPE_CUBE",[Fo]:"ENVMAP_TYPE_CUBE_UV"};function Dx(s){return s.envMap===!1?"ENVMAP_TYPE_CUBE":Ix[s.envMapMode]||"ENVMAP_TYPE_CUBE"}const Lx={[ws]:"ENVMAP_MODE_REFRACTION"};function Nx(s){return s.envMap===!1?"ENVMAP_MODE_REFLECTION":Lx[s.envMapMode]||"ENVMAP_MODE_REFLECTION"}const Ux={[Nu]:"ENVMAP_BLENDING_MULTIPLY",[af]:"ENVMAP_BLENDING_MIX",[lf]:"ENVMAP_BLENDING_ADD"};function Fx(s){return s.envMap===!1?"ENVMAP_BLENDING_NONE":Ux[s.combine]||"ENVMAP_BLENDING_NONE"}function Bx(s){const t=s.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function Ox(s,t,e,n){const i=s.getContext(),r=e.defines;let o=e.vertexShader,a=e.fragmentShader;const l=Px(e),c=Dx(e),h=Nx(e),u=Fx(e),d=Bx(e),f=Mx(e),g=Sx(r),_=i.createProgram();let m,p,x=e.glslVersion?"#version "+e.glslVersion+`
...
`)+`
`+p);const M=x+m+o,y=x+p+a,S=qh(i,i.VERTEX_SHADER,M),E=qh(i,i.FRAGMENT_SHADER,y);i.attachShader(_,S),i.attachShader(_,E),e.index0AttributeName!==void 0?i.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function A(C){if(s.debug.checkShaderErrors){const P=i.getProgramInfoLog(_)||"",L=i.getShaderInfoLog(S)||"",N=i.getShaderInfoLog(E)||"",z=P.trim(),O=L.trim(),H=N.trim();let K=!0,nt=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(K=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,_,S,E);else{const tt=Yh(i,S,"vertex"),ct=Yh(i,E,"fragment");Pt("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
`;continue}if((O=z.match(b))&&(N.gamma=parseFloat(O[1])),(O=z.match(C))&&(N.exposure=parseFloat(O[1])),(O=z.match(P))&&(N.valid|=2,N.format=O[1]),(O=z.match(L))&&(N.valid|=4,N.height=parseInt(O[1],10),N.width=parseInt(O[2],10)),N.valid&2&&N.valid&4)break}return N.valid&2||o(3,"missing format specifier"),N.valid&4||o(3,"missing image size specifier"),N},f=function(R,v,b){const C=v;if(C<8||C>32767||R[0]!==2||R[1]!==2||R[2]&128)return new Uint8Array(R);C!==(R[2]<<8|R[3])&&o(3,"wrong scanline width");const P=new Uint8Array(4*v*b);P.length||o(4,"unable to allocate buffer space");let L=0,N=0;const z=4*C,O=new Uint8Array(4),H=new Uint8Array(z);let K=b;for(;K>0&&N<R.byteLength;){N+4>R.byteLength&&o(1),O[0]=R[N++],O[1]=R[N++],O[2]=R[N++],O[3]=R[N++],(O[0]!=2||O[1]!=2||(O[2]<<8|O[3])!=C)&&o(3,"bad rgbe scanline format");let nt=0,tt;for(;nt<z&&N<R.byteLength;){tt=R[N++];const At=tt>128;if(At&&(tt-=128),(tt===0||nt+tt>z)&&o(3,"bad scanline data"),At){const wt=R[N++];for(let ie=0;ie<tt;ie++)H[nt++]=wt}else H.set(R.subarray(N,N+tt),nt),nt+=tt,N+=tt}const ct=C;for(let At=0;At<ct;At++){let wt=0;P[L]=H[At+wt],wt+=C,P[L+1]=H[At+wt],wt+=C,P[L+2]=H[At+wt],wt+=C,P[L+3]=H[At+wt],L+=4}K--}return P},g=function(R,v,b,C){const P=R[v+3],L=Math.pow(2,P-128)/255;b[C+0]=R[v+0]*L,b[C+1]=R[v+1]*L,b[C+2]=R[v+2]*L,b[C+3]=1},_=function(R,v,b,C){const P=R[v+3],L=Math.pow(2,P-128)/255;b[C+0]=Lr.toHalfFloat(Math.min(R[v+0]*L,65504)),b[C+1]=Lr.toHalfFloat(Math.min(R[v+1]*L,65504)),b[C+2]=Lr.toHalfFloat(Math.min(R[v+2]*L,65504)),b[C+3]=Lr.toHalfFloat(1)},m=new Uint8Array(t);m.pos=0;const p=d(m),x=p.width,M=p.height,y=f(m.subarray(m.pos),x,M);let S,E,A;switch(this.type){case Ue:A=y.length/4;const R=new Float32Array(A*4);for(let b=0;b<A;b++)g(y,b*4,R,b*4);S=R,E=Ue;break;case hn:A=y.length/4;const v=new Uint16Array(A*4);for(let b=0;b<A;b++)_(y,b*4,v,b*4);S=v,E=hn;break;default:throw new Error("THREE.HDRLoader: Unsupported type: "+this.type)}return{width:x,height:M,data:S,header:p.string,gamma:p.gamma,exposure:p.exposure,type:E}}setDataType(t){return this.type=t,this}load(t,e,n,i){function r(o,a){switch(o.type){case Ue:case hn:o.colorSpace=Oe,o.minFilter=fe,o.magFilter=fe,o.generateMipmaps=!1,o.flipY=!0;break}e&&e(o,a)}return super.load(t,r,n,i)}}const fv="modulepreload",pv=function(s){return"/three-player-controller/"+s},uu={},mv=function(t,e,n){let i=Promise.resolve();if(e&&e.length>0){let l=function(c){return Promise.all(c.map(h=>Promise.resolve(h).then(u=>({status:"fulfilled",value:u}),u=>({status:"rejected",reason:u}))))};document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),a=o?.nonce||o?.getAttribute("nonce");i=l(e.map(c=>{if(c=pv(c),c in uu)return;uu[c]=!0;const h=c.endsWith(".css"),u=h?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${u}`))return;const d=document.createElement("link");if(d.rel=h?"stylesheet":fv,h||(d.as="script"),d.crossOrigin="",d.href=c,a&&d.setAttribute("nonce",a),document.head.appendChild(d),h)return new Promise((f,g)=>{d.addEventListener("load",f),d.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${c}`)))})}))}function r(o){const a=new Event("vite:preloadError",{cancelable:!0});if(a.payload=o,window.dispatchEvent(a),!a.defaultPrevented)throw o}return i.then(o=>{for(const a of o||[])a.status==="rejected"&&r(a.reason);return t().catch(r)})},Ad=0,gv=1,_v=2,du=2,Oa=1.25,fu=1,qe=32,Ie=qe/4,wd=65535,xv=Math.pow(2,-24),ka=Symbol("SKIP_GENERATION");function yv(s){return s.index?s.index.count:s.attributes.position.count}function Xi(s){return yv(s)/3}function vv(s,t=ArrayBuffer){return s>65535?new Uint32Array(new t(4*s)):new Uint16Array(new t(2*s))}function Mv(s,t){if(!s.index){const e=s.attributes.position.count,n=t.useSharedArrayBuffer?SharedArrayBuffer:ArrayBuffer,i=vv(e,n);s.setIndex(new ce(i,1));for(let r=0;r<e;r++)i[r]=r}}function Rd(s,t){const e=Xi(s),n=t||s.drawRange,i=n.start/3,r=(n.start+n.count)/3,o=Math.max(0,i),a=Math.min(e,r)-o;return[{offset:Math.floor(o),count:Math.floor(a)}]}function pu(s,t){if(!s.groups||!s.groups.length)return Rd(s,t);const e=[],n=t||s.drawRange,i=n.start/3,r=(n.start+n.count)/3,o=Xi(s),a=[];for(const h of s.groups){const{start:u,count:d}=h,f=u/3,g=isFinite(d)?d:o*3-u,_=(u+g)/3;f<r&&_>i&&(a.push({pos:Math.max(i,f),isStart:!0}),a.push({pos:Math.min(r,_),isStart:!1}))}a.sort((h,u)=>h.pos!==u.pos?h.pos-u.pos:h.type==="end"?-1:1);let l=0,c=null;for(const h of a){const u=h.pos;l!==0&&u!==c&&e.push({offset:c,count:u-c}),l+=h.isStart?1:-1,c=u}return e}function za(s,t,e,n,i){let r=1/0,o=1/0,a=1/0,l=-1/0,c=-1/0,h=-1/0,u=1/0,d=1/0,f=1/0,g=-1/0,_=-1/0,m=-1/0;const p=s.offset||0;for(let x=(t-p)*6,M=(t+e-p)*6;x<M;x+=6){const y=s[x+0],S=s[x+1],E=y-S,A=y+S;E<r&&(r=E),A>l&&(l=A),y<u&&(u=y),y>g&&(g=y);const R=s[x+2],v=s[x+3],b=R-v,C=R+v;b<o&&(o=b),C>c&&(c=C),R<d&&(d=R),R>_&&(_=R);const P=s[x+4],L=s[x+5],N=P-L,z=P+L;N<a&&(a=N),z>h&&(h=z),P<f&&(f=P),P>m&&(m=P)}n[0]=r,n[1]=o,n[2]=a,n[3]=l,n[4]=c,n[5]=h,i[0]=u,i[1]=d,i[2]=f,i[3]=g,i[4]=_,i[5]=m}function mu(s,t,e=null,n=null,i=null){const r=s.attributes.position,o=s.index?s.index.array:null,a=r.normalized;if(i===null)i=new Float32Array(e*6),i.offset=t;else if(t<0||e+t>i.length/6)throw new Error("MeshBVH: compute triangle bounds range is invalid.");const l=r.array,c=r.offset||0;let h=3;r.isInterleavedBufferAttribute&&(h=r.data.stride);const u=["getX","getY","getZ"],d=i.offset;for(let f=t,g=t+e;f<g;f++){const m=(n?n[f]:f)*3,p=(f-d)*6;let x=m+0,M=m+1,y=m+2;o&&(x=o[x],M=o[M],y=o[y]),a||(x=x*h+c,M=M*h+c,y=y*h+c);for(let S=0;S<3;S++){let E,A,R;a?(E=r[u[S]](x),A=r[u[S]](M),R=r[u[S]](y)):(E=l[x+S],A=l[M+S],R=l[y+S]);let v=E;A<v&&(v=A),R<v&&(v=R);let b=E;A>b&&(b=A),R>b&&(b=R);const C=(b-v)/2,P=S*2;i[p+P+0]=v+C,i[p+P+1]=C+(Math.abs(v)+C)*xv}}return i}function me(s,t,e){return e.min.x=t[s],e.min.y=t[s+1],e.min.z=t[s+2],e.max.x=t[s+3],e.max.y=t[s+4],e.max.z=t[s+5],e}function gu(s){let t=-1,e=-1/0;for(let n=0;n<3;n++){const i=s[n+3]-s[n];i>e&&(e=i,t=n)}return t}function _u(s,t){t.set(s)}function xu(s,t,e){let n,i;for(let r=0;r<3;r++){const o=r+3;n=s[r],i=t[r],e[r]=n<i?n:i,n=s[o],i=t[o],e[o]=n>i?n:i}}function no(s,t,e){for(let n=0;n<3;n++){const i=t[s+2*n],r=t[s+2*n+1],o=i-r,a=i+r;o<e[n]&&(e[n]=o),a>e[n+3]&&(e[n+3]=a)}}function Js(s){const t=s[3]-s[0],e=s[4]-s[1],n=s[5]-s[2];return 2*(t*e+e*n+n*t)}const ti=32,Sv=(s,t)=>s.candidate-t.candidate,gi=new Array(ti).fill().map(()=>({count:0,bounds:new Float32Array(6),rightCacheBounds:new Float32Array(6),leftCacheBounds:new Float32Array(6),candidate:0})),io=new Float32Array(6);function bv(s,t,e,n,i,r){let o=-1,a=0;if(r===Ad)o=gu(t),o!==-1&&(a=(t[o]+t[o+3])/2);else if(r===gv)o=gu(s),o!==-1&&(a=Tv(e,n,i,o));else if(r===_v){const l=Js(s);let c=Oa*i;const h=e.offset||0,u=(n-h)*6,d=(n+i-h)*6;for(let f=0;f<3;f++){const g=t[f],p=(t[f+3]-g)/ti;if(i<ti/4){const x=[...gi];x.length=i;let M=0;for(let S=u;S<d;S+=6,M++){const E=x[M];E.candidate=e[S+2*f],E.count=0;const{bounds:A,leftCacheBounds:R,rightCacheBounds:v}=E;for(let b=0;b<3;b++)v[b]=1/0,v[b+3]=-1/0,R[b]=1/0,R[b+3]=-1/0,A[b]=1/0,A[b+3]=-1/0;no(S,e,A)}x.sort(Sv);let y=i;for(let S=0;S<y;S++){const E=x[S];for(;S+1<y&&x[S+1].candidate===E.candidate;)x.splice(S+1,1),y--}for(let S=u;S<d;S+=6){const E=e[S+2*f];for(let A=0;A<y;A++){const R=x[A];E>=R.candidate?no(S,e,R.rightCacheBounds):(no(S,e,R.leftCacheBounds),R.count++)}}for(let S=0;S<y;S++){const E=x[S],A=E.count,R=i-E.count,v=E.leftCacheBounds,b=E.rightCacheBounds;let C=0;A!==0&&(C=Js(v)/l);let P=0;R!==0&&(P=Js(b)/l);const L=fu+Oa*(C*A+P*R);L<c&&(o=f,c=L,a=E.candidate)}}else{for(let y=0;y<ti;y++){const S=gi[y];S.count=0,S.candidate=g+p+y*p;const E=S.bounds;for(let A=0;A<3;A++)E[A]=1/0,E[A+3]=-1/0}for(let y=u;y<d;y+=6){let A=~~((e[y+2*f]-g)/p);A>=ti&&(A=ti-1);const R=gi[A];R.count++,no(y,e,R.bounds)}const x=gi[ti-1];_u(x.bounds,x.rightCacheBounds);for(let y=ti-2;y>=0;y--){const S=gi[y],E=gi[y+1];xu(S.bounds,E.rightCacheBounds,S.rightCacheBounds)}let M=0;for(let y=0;y<ti-1;y++){const S=gi[y],E=S.count,A=S.bounds,v=gi[y+1].rightCacheBounds;E!==0&&(M===0?_u(A,io):xu(A,io,io)),M+=E;let b=0,C=0;M!==0&&(b=Js(io)/l);const P=i-M;P!==0&&(C=Js(v)/l);const L=fu+Oa*(b*M+C*P);L<c&&(o=f,c=L,a=S.candidate)}}}}else console.warn(`MeshBVH: Invalid build strategy value ${r} used.`);return{axis:o,pos:a}}function Tv(s,t,e,n){let i=0;const r=s.offset;for(let o=t,a=t+e;o<a;o++)i+=s[(o-r)*6+n*2];return i/e}class Va{constructor(){this.boundingData=new Float32Array(6)}}function Ev(s,t,e,n,i,r){let o=n,a=n+i-1;const l=r.pos,c=r.axis*2,h=e.offset||0;for(;;){for(;o<=a&&e[(o-h)*6+c]<l;)o++;for(;o<=a&&e[(a-h)*6+c]>=l;)a--;if(o<a){for(let u=0;u<3;u++){let d=t[o*3+u];t[o*3+u]=t[a*3+u],t[a*3+u]=d}for(let u=0;u<6;u++){const d=o-h,f=a-h,g=e[d*6+u];e[d*6+u]=e[f*6+u],e[f*6+u]=g}o++,a--}else return o}}function Av(s,t,e,n,i,r){let o=n,a=n+i-1;const l=r.pos,c=r.axis*2,h=e.offset||0;for(;;){for(;o<=a&&e[(o-h)*6+c]<l;)o++;for(;o<=a&&e[(a-h)*6+c]>=l;)a--;if(o<a){let u=s[o];s[o]=s[a],s[a]=u;for(let d=0;d<6;d++){const f=o-h,g=a-h,_=e[f*6+d];e[f*6+d]=e[g*6+d],e[g*6+d]=_}o++,a--}else return o}}let Cd,Ao,Yl,Pd;const wv=Math.pow(2,32);function Kl(s){return"count"in s?1:1+Kl(s.left)+Kl(s.right)}function Rv(s,t,e){return Cd=new Float32Array(e),Ao=new Uint32Array(e),Yl=new Uint16Array(e),Pd=new Uint8Array(e),Zl(s,t)}function Zl(s,t){const e=s/4,n=s/2,i="count"in t,r=t.boundingData;for(let o=0;o<6;o++)Cd[e+o]=r[o];if(i)return t.buffer?(Pd.set(new Uint8Array(t.buffer),s),s+t.buffer.byteLength):(Ao[e+6]=t.offset,Yl[n+14]=t.count,Yl[n+15]=wd,s+qe);{const{left:o,right:a,splitAxis:l}=t,c=s+qe;let h=Zl(c,o);const u=s/qe,f=h/qe-u;if(f>wv)throw new Error("MeshBVH: Cannot store relative child node offset greater than 32 bits.");return Ao[e+6]=f,Ao[e+7]=l,Zl(h,a)}}function Cv(s,t,e){const i=(s.index?s.index.count:s.attributes.position.count)/3>2**16,r=e.reduce((h,u)=>h+u.count,0),o=i?4:2,a=t?new SharedArrayBuffer(r*o):new ArrayBuffer(r*o),l=i?new Uint32Array(a):new Uint16Array(a);let c=0;for(let h=0;h<e.length;h++){const{offset:u,count:d}=e[h];for(let f=0;f<d;f++)l[c+f]=u+f;c+=d}return l}function Pv(s,t,e,n,i){const{maxDepth:r,verbose:o,maxLeafTris:a,strategy:l,onProgress:c,indirect:h}=i,u=s._indirectBuffer,d=s.geometry,f=d.index?d.index.array:null,g=h?Av:Ev,_=Xi(d),m=new Float32Array(6);let p=!1;const x=new Va;return za(t,e,n,x.boundingData,m),y(x,e,n,m),x;function M(S){c&&c(S/_)}function y(S,E,A,R=null,v=0){if(!p&&v>=r&&(p=!0,o&&(console.warn(`MeshBVH: Max depth of ${r} reached when generating BVH. Consider increasing maxDepth.`),console.warn(d))),A<=a||v>=r)return M(E+A),S.offset=E,S.count=A,S;const b=bv(S.boundingData,R,t,E,A,l);if(b.axis===-1)return M(E+A),S.offset=E,S.count=A,S;const C=g(u,f,t,E,A,b);if(C===E||C===E+A)M(E+A),S.offset=E,S.count=A;else{S.splitAxis=b.axis;const P=new Va,L=E,N=C-E;S.left=P,za(t,L,N,P.boundingData,m),y(P,L,N,m,v+1);const z=new Va,O=C,H=A-N;S.right=z,za(t,O,H,z.boundingData,m),y(z,O,H,m,v+1)}return S}}function Iv(s,t){const e=t.useSharedArrayBuffer?SharedArrayBuffer:ArrayBuffer,n=s.geometry;let i,r;if(t.indirect){const o=pu(n,t.range),a=Cv(n,t.useSharedArrayBuffer,o);s._indirectBuffer=a,i=mu(n,0,a.length,a),r=[{offset:0,count:a.length}]}else{Mv(n,t);const o=Rd(n,t.range)[0];i=mu(n,o.offset,o.count),r=pu(n,t.range)}s._roots=r.map(o=>{const a=Pv(s,i,o.offset,o.count,t),l=Kl(a),c=new e(qe*l);return Rv(0,a,c),c})}class li{constructor(){this.min=1/0,this.max=-1/0}setFromPointsField(t,e){let n=1/0,i=-1/0;for(let r=0,o=t.length;r<o;r++){const l=t[r][e];n=l<n?l:n,i=l>i?l:i}this.min=n,this.max=i}setFromPoints(t,e){let n=1/0,i=-1/0;for(let r=0,o=e.length;r<o;r++){const a=e[r],l=t.dot(a);n=l<n?l:n,i=l>i?l:i}this.min=n,this.max=i}isSeparated(t){return this.min>t.max||t.min>this.max}}li.prototype.setFromBox=(function(){const s=new D;return function(e,n){const i=n.min,r=n.max;let o=1/0,a=-1/0;for(let l=0;l<=1;l++)for(let c=0;c<=1;c++)for(let h=0;h<=1;h++){s.x=i.x*l+r.x*(1-l),s.y=i.y*c+r.y*(1-c),s.z=i.z*h+r.z*(1-h);const u=e.dot(s);o=Math.min(u,o),a=Math.max(u,a)}this.min=o,this.max=a}})();const Dv=(function(){const s=new D,t=new D,e=new D;return function(i,r,o){const a=i.start,l=s,c=r.start,h=t;e.subVectors(a,c),s.subVectors(i.end,i.start),t.subVectors(r.end,r.start);const u=e.dot(h),d=h.dot(l),f=h.dot(h),g=e.dot(l),m=l.dot(l)*f-d*d;let p,x;m!==0?p=(u*d-g*f)/m:p=0,x=(u+p*d)/f,o.x=p,o.y=x}})(),Ec=(function(){const s=new Tt,t=new D,e=new D;return function(i,r,o,a){Dv(i,r,s);let l=s.x,c=s.y;if(l>=0&&l<=1&&c>=0&&c<=1){i.at(l,o),r.at(c,a);return}else if(l>=0&&l<=1){c<0?r.at(0,a):r.at(1,a),i.closestPointToPoint(a,!0,o);return}else if(c>=0&&c<=1){l<0?i.at(0,o):i.at(1,o),r.closestPointToPoint(o,!0,a);return}else{let h;l<0?h=i.start:h=i.end;let u;c<0?u=r.start:u=r.end;const d=t,f=e;if(i.closestPointToPoint(u,!0,t),r.closestPointToPoint(h,!0,e),d.distanceToSquared(u)<=f.distanceToSquared(h)){o.copy(d),a.copy(u);return}else{o.copy(h),a.copy(f);return}}}})(),Lv=(function(){const s=new D,t=new D,e=new On,n=new Pn;return function(r,o){const{radius:a,center:l}=r,{a:c,b:h,c:u}=o;if(n.start=c,n.end=h,n.closestPointToPoint(l,!0,s).distanceTo(l)<=a||(n.start=c,n.end=u,n.closestPointToPoint(l,!0,s).distanceTo(l)<=a)||(n.start=h,n.end=u,n.closestPointToPoint(l,!0,s).distanceTo(l)<=a))return!0;const _=o.getPlane(e);if(Math.abs(_.distanceToPoint(l))<=a){const p=_.projectPoint(l,t);if(o.containsPoint(p))return!0}return!1}})(),Nv=["x","y","z"],ei=1e-15,yu=ei*ei;function pn(s){return Math.abs(s)<ei}class In extends Ne{constructor(...t){super(...t),this.isExtendedTriangle=!0,this.satAxes=new Array(4).fill().map(()=>new D),this.satBounds=new Array(4).fill().map(()=>new li),this.points=[this.a,this.b,this.c],this.plane=new On,this.isDegenerateIntoSegment=!1,this.isDegenerateIntoPoint=!1,this.degenerateSegment=new Pn,this.needsUpdate=!0}intersectsSphere(t){return Lv(t,this)}update(){const t=this.a,e=this.b,n=this.c,i=this.points,r=this.satAxes,o=this.satBounds,a=r[0],l=o[0];this.getNormal(a),l.setFromPoints(a,i);const c=r[1],h=o[1];c.subVectors(t,e),h.setFromPoints(c,i);const u=r[2],d=o[2];u.subVectors(e,n),d.setFromPoints(u,i);const f=r[3],g=o[3];f.subVectors(n,t),g.setFromPoints(f,i);const _=c.length(),m=u.length(),p=f.length();this.isDegenerateIntoPoint=!1,this.isDegenerateIntoSegment=!1,_<ei?m<ei||p<ei?this.isDegenerateIntoPoint=!0:(this.isDegenerateIntoSegment=!0,this.degenerateSegment.start.copy(t),this.degenerateSegment.end.copy(n)):m<ei?p<ei?this.isDegenerateIntoPoint=!0:(this.isDegenerateIntoSegment=!0,this.degenerateSegment.start.copy(e),this.degenerateSegment.end.copy(t)):p<ei&&(this.isDegenerateIntoSegment=!0,this.degenerateSegment.start.copy(n),this.degenerateSegment.end.copy(e)),this.plane.setFromNormalAndCoplanarPoint(a,t),this.needsUpdate=!1}}In.prototype.closestPointToSegment=(function(){const s=new D,t=new D,e=new Pn;return function(i,r=null,o=null){const{start:a,end:l}=i,c=this.points;let h,u=1/0;for(let d=0;d<3;d++){const f=(d+1)%3;e.start.copy(c[d]),e.end.copy(c[f]),Ec(e,i,s,t),h=s.distanceToSquared(t),h<u&&(u=h,r&&r.copy(s),o&&o.copy(t))}return this.closestPointToPoint(a,s),h=a.distanceToSquared(s),h<u&&(u=h,r&&r.copy(s),o&&o.copy(a)),this.closestPointToPoint(l,s),h=l.distanceToSquared(s),h<u&&(u=h,r&&r.copy(s),o&&o.copy(l)),Math.sqrt(u)}})();In.prototype.intersectsTriangle=(function(){const s=new In,t=new li,e=new li,n=new D,i=new D,r=new D,o=new D,a=new Pn,l=new Pn,c=new D,h=new Tt,u=new Tt;function d(M,y,S,E){const A=n;!M.isDegenerateIntoPoint&&!M.isDegenerateIntoSegment?A.copy(M.plane.normal):A.copy(y.plane.normal);const R=M.satBounds,v=M.satAxes;for(let P=1;P<4;P++){const L=R[P],N=v[P];if(t.setFromPoints(N,y.points),L.isSeparated(t)||(o.copy(A).cross(N),t.setFromPoints(o,M.points),e.setFromPoints(o,y.points),t.isSeparated(e)))return!1}const b=y.satBounds,C=y.satAxes;for(let P=1;P<4;P++){const L=b[P],N=C[P];if(t.setFromPoints(N,M.points),L.isSeparated(t)||(o.crossVectors(A,N),t.setFromPoints(o,M.points),e.setFromPoints(o,y.points),t.isSeparated(e)))return!1}return S&&(E||console.warn("ExtendedTriangle.intersectsTriangle: Triangles are coplanar which does not support an output edge. Setting edge to 0, 0, 0."),S.start.set(0,0,0),S.end.set(0,0,0)),!0}function f(M,y,S,E,A,R,v,b,C,P,L){let N=v/(v-b);P.x=E+(A-E)*N,L.start.subVectors(y,M).multiplyScalar(N).add(M),N=v/(v-C),P.y=E+(R-E)*N,L.end.subVectors(S,M).multiplyScalar(N).add(M)}function g(M,y,S,E,A,R,v,b,C,P,L){if(A>0)f(M.c,M.a,M.b,E,y,S,C,v,b,P,L);else if(R>0)f(M.b,M.a,M.c,S,y,E,b,v,C,P,L);else if(b*C>0||v!=0)f(M.a,M.b,M.c,y,S,E,v,b,C,P,L);else if(b!=0)f(M.b,M.a,M.c,S,y,E,b,v,C,P,L);else if(C!=0)f(M.c,M.a,M.b,E,y,S,C,v,b,P,L);else return!0;return!1}function _(M,y,S,E){const A=y.degenerateSegment,R=M.plane.distanceToPoint(A.start),v=M.plane.distanceToPoint(A.end);return pn(R)?pn(v)?d(M,y,S,E):(S&&(S.start.copy(A.start),S.end.copy(A.start)),M.containsPoint(A.start)):pn(v)?(S&&(S.start.copy(A.end),S.end.copy(A.end)),M.containsPoint(A.end)):M.plane.intersectLine(A,n)!=null?(S&&(S.start.copy(n),S.end.copy(n)),M.containsPoint(n)):!1}function m(M,y,S){const E=y.a;return pn(M.plane.distanceToPoint(E))&&M.containsPoint(E)?(S&&(S.start.copy(E),S.end.copy(E)),!0):!1}function p(M,y,S){const E=M.degenerateSegment,A=y.a;return E.closestPointToPoint(A,!0,n),A.distanceToSquared(n)<yu?(S&&(S.start.copy(A),S.end.copy(A)),!0):!1}function x(M,y,S,E){if(M.isDegenerateIntoSegment)if(y.isDegenerateIntoSegment){const A=M.degenerateSegment,R=y.degenerateSegment,v=i,b=r;A.delta(v),R.delta(b);const C=n.subVectors(R.start,A.start),P=v.x*b.y-v.y*b.x;if(pn(P))return!1;const L=(C.x*b.y-C.y*b.x)/P,N=-(v.x*C.y-v.y*C.x)/P;if(L<0||L>1||N<0||N>1)return!1;const z=A.start.z+v.z*L,O=R.start.z+b.z*N;return pn(z-O)?(S&&(S.start.copy(A.start).addScaledVector(v,L),S.end.copy(A.start).addScaledVector(v,L)),!0):!1}else return y.isDegenerateIntoPoint?p(M,y,S):_(y,M,S,E);else{if(M.isDegenerateIntoPoint)return y.isDegenerateIntoPoint?y.a.distanceToSquared(M.a)<yu?(S&&(S.start.copy(M.a),S.end.copy(M.a)),!0):!1:y.isDegenerateIntoSegment?p(y,M,S):m(y,M,S);if(y.isDegenerateIntoPoint)return m(M,y,S);if(y.isDegenerateIntoSegment)return _(M,y,S,E)}}return function(y,S=null,E=!1){this.needsUpdate&&this.update(),y.isExtendedTriangle?y.needsUpdate&&y.update():(s.copy(y),s.update(),y=s);const A=x(this,y,S,E);if(A!==void 0)return A;const R=this.plane,v=y.plane;let b=v.distanceToPoint(this.a),C=v.distanceToPoint(this.b),P=v.distanceToPoint(this.c);pn(b)&&(b=0),pn(C)&&(C=0),pn(P)&&(P=0);const L=b*C,N=b*P;if(L>0&&N>0)return!1;let z=R.distanceToPoint(y.a),O=R.distanceToPoint(y.b),H=R.distanceToPoint(y.c);pn(z)&&(z=0),pn(O)&&(O=0),pn(H)&&(H=0);const K=z*O,nt=z*H;if(K>0&&nt>0)return!1;i.copy(R.normal),r.copy(v.normal);const tt=i.cross(r);let ct=0,At=Math.abs(tt.x);const wt=Math.abs(tt.y);wt>At&&(At=wt,ct=1),Math.abs(tt.z)>At&&(ct=2);const qt=Nv[ct],j=this.a[qt],J=this.b[qt],pt=this.c[qt],Ft=y.a[qt],gt=y.b[qt],Wt=y.c[qt];if(g(this,j,J,pt,L,N,b,C,P,h,a))return d(this,y,S,E);if(g(y,Ft,gt,Wt,K,nt,z,O,H,u,l))return d(this,y,S,E);if(h.y<h.x){const ge=h.y;h.y=h.x,h.x=ge,c.copy(a.start),a.start.copy(a.end),a.end.copy(c)}if(u.y<u.x){const ge=u.y;u.y=u.x,u.x=ge,c.copy(l.start),l.start.copy(l.end),l.end.copy(c)}return h.y<u.x||u.y<h.x?!1:(S&&(u.x>h.x?S.start.copy(l.start):S.start.copy(a.start),u.y<h.y?S.end.copy(l.end):S.end.copy(a.end)),!0)}})();In.prototype.distanceToPoint=(function(){const s=new D;return function(e){return this.closestPointToPoint(e,s),e.distanceTo(s)}})();In.prototype.distanceToTriangle=(function(){const s=new D,t=new D,e=["a","b","c"],n=new Pn,i=new Pn;return function(o,a=null,l=null){const c=a||l?n:null;if(this.intersectsTriangle(o,c))return(a||l)&&(a&&c.getCenter(a),l&&c.getCenter(l)),0;let h=1/0;for(let u=0;u<3;u++){let d;const f=e[u],g=o[f];this.closestPointToPoint(g,s),d=g.distanceToSquared(s),d<h&&(h=d,a&&a.copy(s),l&&l.copy(g));const _=this[f];o.closestPointToPoint(_,s),d=_.distanceToSquared(s),d<h&&(h=d,a&&a.copy(_),l&&l.copy(s))}for(let u=0;u<3;u++){const d=e[u],f=e[(u+1)%3];n.set(this[d],this[f]);for(let g=0;g<3;g++){const _=e[g],m=e[(g+1)%3];i.set(o[_],o[m]),Ec(n,i,s,t);const p=s.distanceToSquared(t);p<h&&(h=p,a&&a.copy(s),l&&l.copy(t))}}return Math.sqrt(h)}})();class Ke{constructor(t,e,n){this.isOrientedBox=!0,this.min=new D,this.max=new D,this.matrix=new Et,this.invMatrix=new Et,this.points=new Array(8).fill().map(()=>new D),this.satAxes=new Array(3).fill().map(()=>new D),this.satBounds=new Array(3).fill().map(()=>new li),this.alignedSatBounds=new Array(3).fill().map(()=>new li),this.needsUpdate=!1,t&&this.min.copy(t),e&&this.max.copy(e),n&&this.matrix.copy(n)}set(t,e,n){this.min.copy(t),this.max.copy(e),this.matrix.copy(n),this.needsUpdate=!0}copy(t){this.min.copy(t.min),this.max.copy(t.max),this.matrix.copy(t.matrix),this.needsUpdate=!0}}Ke.prototype.update=(function(){return function(){const t=this.matrix,e=this.min,n=this.max,i=this.points;for(let c=0;c<=1;c++)for(let h=0;h<=1;h++)for(let u=0;u<=1;u++){const d=1*c|2*h|4*u,f=i[d];f.x=c?n.x:e.x,f.y=h?n.y:e.y,f.z=u?n.z:e.z,f.applyMatrix4(t)}const r=this.satBounds,o=this.satAxes,a=i[0];for(let c=0;c<3;c++){const h=o[c],u=r[c],d=1<<c,f=i[d];h.subVectors(a,f),u.setFromPoints(h,i)}const l=this.alignedSatBounds;l[0].setFromPointsField(i,"x"),l[1].setFromPointsField(i,"y"),l[2].setFromPointsField(i,"z"),this.invMatrix.copy(this.matrix).invert(),this.needsUpdate=!1}})();Ke.prototype.intersectsBox=(function(){const s=new li;return function(e){this.needsUpdate&&this.update();const n=e.min,i=e.max,r=this.satBounds,o=this.satAxes,a=this.alignedSatBounds;if(s.min=n.x,s.max=i.x,a[0].isSeparated(s)||(s.min=n.y,s.max=i.y,a[1].isSeparated(s))||(s.min=n.z,s.max=i.z,a[2].isSeparated(s)))return!1;for(let l=0;l<3;l++){const c=o[l],h=r[l];if(s.setFromBox(c,e),h.isSeparated(s))return!1}return!0}})();Ke.prototype.intersectsTriangle=(function(){const s=new In,t=new Array(3),e=new li,n=new li,i=new D;return function(o){this.needsUpdate&&this.update(),o.isExtendedTriangle?o.needsUpdate&&o.update():(s.copy(o),s.update(),o=s);const a=this.satBounds,l=this.satAxes;t[0]=o.a,t[1]=o.b,t[2]=o.c;for(let d=0;d<3;d++){const f=a[d],g=l[d];if(e.setFromPoints(g,t),f.isSeparated(e))return!1}const c=o.satBounds,h=o.satAxes,u=this.points;for(let d=0;d<3;d++){const f=c[d],g=h[d];if(e.setFromPoints(g,u),f.isSeparated(e))return!1}for(let d=0;d<3;d++){const f=l[d];for(let g=0;g<4;g++){const _=h[g];if(i.crossVectors(f,_),e.setFromPoints(i,t),n.setFromPoints(i,u),e.isSeparated(n))return!1}}return!0}})();Ke.prototype.closestPointToPoint=(function(){return function(t,e){return this.needsUpdate&&this.update(),e.copy(t).applyMatrix4(this.invMatrix).clamp(this.min,this.max).applyMatrix4(this.matrix),e}})();Ke.prototype.distanceToPoint=(function(){const s=new D;return function(e){return this.closestPointToPoint(e,s),e.distanceTo(s)}})();Ke.prototype.distanceToBox=(function(){const s=["x","y","z"],t=new Array(12).fill().map(()=>new Pn),e=new Array(12).fill().map(()=>new Pn),n=new D,i=new D;return function(o,a=0,l=null,c=null){if(this.needsUpdate&&this.update(),this.intersectsBox(o))return(l||c)&&(o.getCenter(i),this.closestPointToPoint(i,n),o.closestPointToPoint(n,i),l&&l.copy(n),c&&c.copy(i)),0;const h=a*a,u=o.min,d=o.max,f=this.points;let g=1/0;for(let m=0;m<8;m++){const p=f[m];i.copy(p).clamp(u,d);const x=p.distanceToSquared(i);if(x<g&&(g=x,l&&l.copy(p),c&&c.copy(i),x<h))return Math.sqrt(x)}let _=0;for(let m=0;m<3;m++)for(let p=0;p<=1;p++)for(let x=0;x<=1;x++){const M=(m+1)%3,y=(m+2)%3,S=p<<M|x<<y,E=1<<m|p<<M|x<<y,A=f[S],R=f[E];t[_].set(A,R);const b=s[m],C=s[M],P=s[y],L=e[_],N=L.start,z=L.end;N[b]=u[b],N[C]=p?u[C]:d[C],N[P]=x?u[P]:d[C],z[b]=d[b],z[C]=p?u[C]:d[C],z[P]=x?u[P]:d[C],_++}for(let m=0;m<=1;m++)for(let p=0;p<=1;p++)for(let x=0;x<=1;x++){i.x=m?d.x:u.x,i.y=p?d.y:u.y,i.z=x?d.z:u.z,this.closestPointToPoint(i,n);const M=i.distanceToSquared(n);if(M<g&&(g=M,l&&l.copy(n),c&&c.copy(i),M<h))return Math.sqrt(M)}for(let m=0;m<12;m++){const p=t[m];for(let x=0;x<12;x++){const M=e[x];Ec(p,M,n,i);const y=n.distanceToSquared(i);if(y<g&&(g=y,l&&l.copy(n),c&&c.copy(i),y<h))return Math.sqrt(y)}}return Math.sqrt(g)}})();class Ac{constructor(t){this._getNewPrimitive=t,this._primitives=[]}getPrimitive(){const t=this._primitives;return t.length===0?this._getNewPrimitive():t.pop()}releasePrimitive(t){this._primitives.push(t)}}class Uv extends Ac{constructor(){super(()=>new In)}}const xn=new Uv;function De(s,t){return t[s+15]===wd}function un(s,t){return t[s+6]}function yn(s,t){return t[s+14]}function Fe(s){return s+Ie}function Be(s,t){const e=t[s+6];return s+e*Ie}function wc(s,t){return t[s+7]}class Fv{constructor(){this.float32Array=null,this.uint16Array=null,this.uint32Array=null;const t=[];let e=null;this.setBuffer=n=>{e&&t.push(e),e=n,this.float32Array=new Float32Array(n),this.uint16Array=new Uint16Array(n),this.uint32Array=new Uint32Array(n)},this.clearBuffer=()=>{e=null,this.float32Array=null,this.uint16Array=null,this.uint32Array=null,t.length!==0&&this.setBuffer(t.pop())}}}const de=new Fv;let Mi,Ms;const us=[],so=new Ac(()=>new ue);function Bv(s,t,e,n,i,r){Mi=so.getPrimitive(),Ms=so.getPrimitive(),us.push(Mi,Ms),de.setBuffer(s._roots[t]);const o=Jl(0,s.geometry,e,n,i,r);de.clearBuffer(),so.releasePrimitive(Mi),so.releasePrimitive(Ms),us.pop(),us.pop();const a=us.length;return a>0&&(Ms=us[a-1],Mi=us[a-2]),o}function Jl(s,t,e,n,i=null,r=0,o=0){const{float32Array:a,uint16Array:l,uint32Array:c}=de;let h=s*2;if(De(h,l)){const d=un(s,c),f=yn(h,l);return me(s,a,Mi),n(d,f,!1,o,r+s/Ie,Mi)}else{let b=function(P){const{uint16Array:L,uint32Array:N}=de;let z=P*2;for(;!De(z,L);)P=Fe(P),z=P*2;return un(P,N)},C=function(P){const{uint16Array:L,uint32Array:N}=de;let z=P*2;for(;!De(z,L);)P=Be(P,N),z=P*2;return un(P,N)+yn(z,L)};const d=Fe(s),f=Be(s,c);let g=d,_=f,m,p,x,M;if(i&&(x=Mi,M=Ms,me(g,a,x),me(_,a,M),m=i(x),p=i(M),p<m)){g=f,_=d;const P=m;m=p,p=P,x=M}x||(x=Mi,me(g,a,x));const y=De(g*2,l),S=e(x,y,m,o+1,r+g/Ie);let E;if(S===du){const P=b(g),N=C(g)-P;E=n(P,N,!0,o+1,r+g/Ie,x)}else E=S&&Jl(g,t,e,n,i,r,o+1);if(E)return!0;M=Ms,me(_,a,M);const A=De(_*2,l),R=e(M,A,p,o+1,r+_/Ie);let v;if(R===du){const P=b(_),N=C(_)-P;v=n(P,N,!0,o+1,r+_/Ie,M)}else v=R&&Jl(_,t,e,n,i,r,o+1);return!!v}}const $s=new D,Ga=new D;function Ov(s,t,e={},n=0,i=1/0){const r=n*n,o=i*i;let a=1/0,l=null;if(s.shapecast({boundsTraverseOrder:h=>($s.copy(t).clamp(h.min,h.max),$s.distanceToSquared(t)),intersectsBounds:(h,u,d)=>d<a&&d<o,intersectsTriangle:(h,u)=>{h.closestPointToPoint(t,$s);const d=t.distanceToSquared($s);return d<a&&(Ga.copy($s),a=d,l=u),d<r}}),a===1/0)return null;const c=Math.sqrt(a);return e.point?e.point.copy(Ga):e.point=Ga.clone(),e.distance=c,e.faceIndex=l,e}const ro=parseInt(vr)>=169,kv=parseInt(vr)<=161,Bi=new D,Oi=new D,ki=new D,oo=new Tt,ao=new Tt,lo=new Tt,vu=new D,Mu=new D,Su=new D,Qs=new D;function zv(s,t,e,n,i,r,o,a){let l;if(r===je?l=s.intersectTriangle(n,e,t,!0,i):l=s.intersectTriangle(t,e,n,r!==_n,i),l===null)return null;const c=s.origin.distanceTo(i);return c<o||c>a?null:{distance:c,point:i.clone()}}function bu(s,t,e,n,i,r,o,a,l,c,h){Bi.fromBufferAttribute(t,r),Oi.fromBufferAttribute(t,o),ki.fromBufferAttribute(t,a);const u=zv(s,Bi,Oi,ki,Qs,l,c,h);if(u){if(n){oo.fromBufferAttribute(n,r),ao.fromBufferAttribute(n,o),lo.fromBufferAttribute(n,a),u.uv=new Tt;const f=Ne.getInterpolation(Qs,Bi,Oi,ki,oo,ao,lo,u.uv);ro||(u.uv=f)}if(i){oo.fromBufferAttribute(i,r),ao.fromBufferAttribute(i,o),lo.fromBufferAttribute(i,a),u.uv1=new Tt;const f=Ne.getInterpolation(Qs,Bi,Oi,ki,oo,ao,lo,u.uv1);ro||(u.uv1=f),kv&&(u.uv2=u.uv1)}if(e){vu.fromBufferAttribute(e,r),Mu.fromBufferAttribute(e,o),Su.fromBufferAttribute(e,a),u.normal=new D;const f=Ne.getInterpolation(Qs,Bi,Oi,ki,vu,Mu,Su,u.normal);u.normal.dot(s.direction)>0&&u.normal.multiplyScalar(-1),ro||(u.normal=f)}const d={a:r,b:o,c:a,normal:new D,materialIndex:0};if(Ne.getNormal(Bi,Oi,ki,d.normal),u.face=d,u.faceIndex=r,ro){const f=new D;Ne.getBarycoord(Qs,Bi,Oi,ki,f),u.barycoord=f}}return u}function Tu(s){return s&&s.isMaterial?s.side:s}function Xo(s,t,e,n,i,r,o){const a=n*3;let l=a+0,c=a+1,h=a+2;const{index:u,groups:d}=s;s.index&&(l=u.getX(l),c=u.getX(c),h=u.getX(h));const{position:f,normal:g,uv:_,uv1:m}=s.attributes;if(Array.isArray(t)){const p=n*3;for(let x=0,M=d.length;x<M;x++){const{start:y,count:S,materialIndex:E}=d[x];if(p>=y&&p<y+S){const A=Tu(t[E]),R=bu(e,f,g,_,m,l,c,h,A,r,o);if(R)if(R.faceIndex=n,R.face.materialIndex=E,i)i.push(R);else return R}}}else{const p=Tu(t),x=bu(e,f,g,_,m,l,c,h,p,r,o);if(x)if(x.faceIndex=n,x.face.materialIndex=0,i)i.push(x);else return x}return null}function Te(s,t,e,n){const i=s.a,r=s.b,o=s.c;let a=t,l=t+1,c=t+2;e&&(a=e.getX(a),l=e.getX(l),c=e.getX(c)),i.x=n.getX(a),i.y=n.getY(a),i.z=n.getZ(a),r.x=n.getX(l),r.y=n.getY(l),r.z=n.getZ(l),o.x=n.getX(c),o.y=n.getY(c),o.z=n.getZ(c)}function Vv(s,t,e,n,i,r,o,a){const{geometry:l,_indirectBuffer:c}=s;for(let h=n,u=n+i;h<u;h++)Xo(l,t,e,h,r,o,a)}function Gv(s,t,e,n,i,r,o){const{geometry:a,_indirectBuffer:l}=s;let c=1/0,h=null;for(let u=n,d=n+i;u<d;u++){let f;f=Xo(a,t,e,u,null,r,o),f&&f.distance<c&&(h=f,c=f.distance)}return h}function Hv(s,t,e,n,i,r,o){const{geometry:a}=e,{index:l}=a,c=a.attributes.position;for(let h=s,u=t+s;h<u;h++){let d;if(d=h,Te(o,d*3,l,c),o.needsUpdate=!0,n(o,d,i,r))return!0}return!1}function Wv(s,t=null){t&&Array.isArray(t)&&(t=new Set(t));const e=s.geometry,n=e.index?e.index.array:null,i=e.attributes.position;let r,o,a,l,c=0;const h=s._roots;for(let d=0,f=h.length;d<f;d++)r=h[d],o=new Uint32Array(r),a=new Uint16Array(r),l=new Float32Array(r),u(0,c),c+=r.byteLength;function u(d,f,g=!1){const _=d*2;if(De(_,a)){const m=o[d+6],p=a[_+14];let x=1/0,M=1/0,y=1/0,S=-1/0,E=-1/0,A=-1/0;for(let R=3*m,v=3*(m+p);R<v;R++){let b=n[R];const C=i.getX(b),P=i.getY(b),L=i.getZ(b);C<x&&(x=C),C>S&&(S=C),P<M&&(M=P),P>E&&(E=P),L<y&&(y=L),L>A&&(A=L)}return l[d+0]!==x||l[d+1]!==M||l[d+2]!==y||l[d+3]!==S||l[d+4]!==E||l[d+5]!==A?(l[d+0]=x,l[d+1]=M,l[d+2]=y,l[d+3]=S,l[d+4]=E,l[d+5]=A,!0):!1}else{const m=Fe(d),p=Be(d,o);let x=g,M=!1,y=!1;if(t){if(!x){const b=m/Ie+f/qe,C=p/Ie+f/qe;M=t.has(b),y=t.has(C),x=!M&&!y}}else M=!0,y=!0;const S=x||M,E=x||y;let A=!1;S&&(A=u(m,f,x));let R=!1;E&&(R=u(p,f,x));const v=A||R;if(v)for(let b=0;b<3;b++){const C=m+b,P=p+b,L=l[C],N=l[C+3],z=l[P],O=l[P+3];l[d+b]=L<z?L:z,l[d+b+3]=N>O?N:O}return v}}}function bi(s,t,e,n,i){let r,o,a,l,c,h;const u=1/e.direction.x,d=1/e.direction.y,f=1/e.direction.z,g=e.origin.x,_=e.origin.y,m=e.origin.z;let p=t[s],x=t[s+3],M=t[s+1],y=t[s+3+1],S=t[s+2],E=t[s+3+2];return u>=0?(r=(p-g)*u,o=(x-g)*u):(r=(x-g)*u,o=(p-g)*u),d>=0?(a=(M-_)*d,l=(y-_)*d):(a=(y-_)*d,l=(M-_)*d),r>l||a>o||((a>r||isNaN(r))&&(r=a),(l<o||isNaN(o))&&(o=l),f>=0?(c=(S-m)*f,h=(E-m)*f):(c=(E-m)*f,h=(S-m)*f),r>h||c>o)?!1:((c>r||r!==r)&&(r=c),(h<o||o!==o)&&(o=h),r<=i&&o>=n)}function Xv(s,t,e,n,i,r,o,a){const{geometry:l,_indirectBuffer:c}=s;for(let h=n,u=n+i;h<u;h++){let d=c?c[h]:h;Xo(l,t,e,d,r,o,a)}}function qv(s,t,e,n,i,r,o){const{geometry:a,_indirectBuffer:l}=s;let c=1/0,h=null;for(let u=n,d=n+i;u<d;u++){let f;f=Xo(a,t,e,l?l[u]:u,null,r,o),f&&f.distance<c&&(h=f,c=f.distance)}return h}function jv(s,t,e,n,i,r,o){const{geometry:a}=e,{index:l}=a,c=a.attributes.position;for(let h=s,u=t+s;h<u;h++){let d;if(d=e.resolveTriangleIndex(h),Te(o,d*3,l,c),o.needsUpdate=!0,n(o,d,i,r))return!0}return!1}function Yv(s,t,e,n,i,r,o){de.setBuffer(s._roots[t]),$l(0,s,e,n,i,r,o),de.clearBuffer()}function $l(s,t,e,n,i,r,o){const{float32Array:a,uint16Array:l,uint32Array:c}=de,h=s*2;if(De(h,l)){const d=un(s,c),f=yn(h,l);Vv(t,e,n,d,f,i,r,o)}else{const d=Fe(s);bi(d,a,n,r,o)&&$l(d,t,e,n,i,r,o);const f=Be(s,c);bi(f,a,n,r,o)&&$l(f,t,e,n,i,r,o)}}const Kv=["x","y","z"];function Zv(s,t,e,n,i,r){de.setBuffer(s._roots[t]);const o=Ql(0,s,e,n,i,r);return de.clearBuffer(),o}function Ql(s,t,e,n,i,r){const{float32Array:o,uint16Array:a,uint32Array:l}=de;let c=s*2;if(De(c,a)){const u=un(s,l),d=yn(c,a);return Gv(t,e,n,u,d,i,r)}else{const u=wc(s,l),d=Kv[u],g=n.direction[d]>=0;let _,m;g?(_=Fe(s),m=Be(s,l)):(_=Be(s,l),m=Fe(s));const x=bi(_,o,n,i,r)?Ql(_,t,e,n,i,r):null;if(x){const S=x.point[d];if(g?S<=o[m+u]:S>=o[m+u+3])return x}const y=bi(m,o,n,i,r)?Ql(m,t,e,n,i,r):null;return x&&y?x.distance<=y.distance?x:y:x||y||null}}const co=new ue,ds=new In,fs=new In,tr=new Et,Eu=new Ke,ho=new Ke;function Jv(s,t,e,n){de.setBuffer(s._roots[t]);const i=tc(0,s,e,n);return de.clearBuffer(),i}function tc(s,t,e,n,i=null){const{float32Array:r,uint16Array:o,uint32Array:a}=de;let l=s*2;if(i===null&&(e.boundingBox||e.computeBoundingBox(),Eu.set(e.boundingBox.min,e.boundingBox.max,n),i=Eu),De(l,o)){const h=t.geometry,u=h.index,d=h.attributes.position,f=e.index,g=e.attributes.position,_=un(s,a),m=yn(l,o);if(tr.copy(n).invert(),e.boundsTree)return me(s,r,ho),ho.matrix.copy(tr),ho.needsUpdate=!0,e.boundsTree.shapecast({intersectsBounds:x=>ho.intersectsBox(x),intersectsTriangle:x=>{x.a.applyMatrix4(n),x.b.applyMatrix4(n),x.c.applyMatrix4(n),x.needsUpdate=!0;for(let M=_*3,y=(m+_)*3;M<y;M+=3)if(Te(fs,M,u,d),fs.needsUpdate=!0,x.intersectsTriangle(fs))return!0;return!1}});{const p=Xi(e);for(let x=_*3,M=(m+_)*3;x<M;x+=3){Te(ds,x,u,d),ds.a.applyMatrix4(tr),ds.b.applyMatrix4(tr),ds.c.applyMatrix4(tr),ds.needsUpdate=!0;for(let y=0,S=p*3;y<S;y+=3)if(Te(fs,y,f,g),fs.needsUpdate=!0,ds.intersectsTriangle(fs))return!0}}}else{const h=Fe(s),u=Be(s,a);return me(h,r,co),!!(i.intersectsBox(co)&&tc(h,t,e,n,i)||(me(u,r,co),i.intersectsBox(co)&&tc(u,t,e,n,i)))}}const uo=new Et,Ha=new Ke,er=new Ke,$v=new D,Qv=new D,tM=new D,eM=new D;function nM(s,t,e,n={},i={},r=0,o=1/0){t.boundingBox||t.computeBoundingBox(),Ha.set(t.boundingBox.min,t.boundingBox.max,e),Ha.needsUpdate=!0;const a=s.geometry,l=a.attributes.position,c=a.index,h=t.attributes.position,u=t.index,d=xn.getPrimitive(),f=xn.getPrimitive();let g=$v,_=Qv,m=null,p=null;i&&(m=tM,p=eM);let x=1/0,M=null,y=null;return uo.copy(e).invert(),er.matrix.copy(uo),s.shapecast({boundsTraverseOrder:S=>Ha.distanceToBox(S),intersectsBounds:(S,E,A)=>A<x&&A<o?(E&&(er.min.copy(S.min),er.max.copy(S.max),er.needsUpdate=!0),!0):!1,intersectsRange:(S,E)=>{if(t.boundsTree)return t.boundsTree.shapecast({boundsTraverseOrder:R=>er.distanceToBox(R),intersectsBounds:(R,v,b)=>b<x&&b<o,intersectsRange:(R,v)=>{for(let b=R,C=R+v;b<C;b++){Te(f,3*b,u,h),f.a.applyMatrix4(e),f.b.applyMatrix4(e),f.c.applyMatrix4(e),f.needsUpdate=!0;for(let P=S,L=S+E;P<L;P++){Te(d,3*P,c,l),d.needsUpdate=!0;const N=d.distanceToTriangle(f,g,m);if(N<x&&(_.copy(g),p&&p.copy(m),x=N,M=P,y=b),N<r)return!0}}}});{const A=Xi(t);for(let R=0,v=A;R<v;R++){Te(f,3*R,u,h),f.a.applyMatrix4(e),f.b.applyMatrix4(e),f.c.applyMatrix4(e),f.needsUpdate=!0;for(let b=S,C=S+E;b<C;b++){Te(d,3*b,c,l),d.needsUpdate=!0;const P=d.distanceToTriangle(f,g,m);if(P<x&&(_.copy(g),p&&p.copy(m),x=P,M=b,y=R),P<r)return!0}}}}}),xn.releasePrimitive(d),xn.releasePrimitive(f),x===1/0?null:(n.point?n.point.copy(_):n.point=_.clone(),n.distance=x,n.faceIndex=M,i&&(i.point?i.point.copy(p):i.point=p.clone(),i.point.applyMatrix4(uo),_.applyMatrix4(uo),i.distance=_.sub(i.point).length(),i.faceIndex=y),n)}function iM(s,t=null){t&&Array.isArray(t)&&(t=new Set(t));const e=s.geometry,n=e.index?e.index.array:null,i=e.attributes.position;let r,o,a,l,c=0;const h=s._roots;for(let d=0,f=h.length;d<f;d++)r=h[d],o=new Uint32Array(r),a=new Uint16Array(r),l=new Float32Array(r),u(0,c),c+=r.byteLength;function u(d,f,g=!1){const _=d*2;if(De(_,a)){const m=o[d+6],p=a[_+14];let x=1/0,M=1/0,y=1/0,S=-1/0,E=-1/0,A=-1/0;for(let R=m,v=m+p;R<v;R++){const b=3*s.resolveTriangleIndex(R);for(let C=0;C<3;C++){let P=b+C;P=n?n[P]:P;const L=i.getX(P),N=i.getY(P),z=i.getZ(P);L<x&&(x=L),L>S&&(S=L),N<M&&(M=N),N>E&&(E=N),z<y&&(y=z),z>A&&(A=z)}}return l[d+0]!==x||l[d+1]!==M||l[d+2]!==y||l[d+3]!==S||l[d+4]!==E||l[d+5]!==A?(l[d+0]=x,l[d+1]=M,l[d+2]=y,l[d+3]=S,l[d+4]=E,l[d+5]=A,!0):!1}else{const m=Fe(d),p=Be(d,o);let x=g,M=!1,y=!1;if(t){if(!x){const b=m/Ie+f/qe,C=p/Ie+f/qe;M=t.has(b),y=t.has(C),x=!M&&!y}}else M=!0,y=!0;const S=x||M,E=x||y;let A=!1;S&&(A=u(m,f,x));let R=!1;E&&(R=u(p,f,x));const v=A||R;if(v)for(let b=0;b<3;b++){const C=m+b,P=p+b,L=l[C],N=l[C+3],z=l[P],O=l[P+3];l[d+b]=L<z?L:z,l[d+b+3]=N>O?N:O}return v}}}function sM(s,t,e,n,i,r,o){de.setBuffer(s._roots[t]),ec(0,s,e,n,i,r,o),de.clearBuffer()}function ec(s,t,e,n,i,r,o){const{float32Array:a,uint16Array:l,uint32Array:c}=de,h=s*2;if(De(h,l)){const d=un(s,c),f=yn(h,l);Xv(t,e,n,d,f,i,r,o)}else{const d=Fe(s);bi(d,a,n,r,o)&&ec(d,t,e,n,i,r,o);const f=Be(s,c);bi(f,a,n,r,o)&&ec(f,t,e,n,i,r,o)}}const rM=["x","y","z"];function oM(s,t,e,n,i,r){de.setBuffer(s._roots[t]);const o=nc(0,s,e,n,i,r);return de.clearBuffer(),o}function nc(s,t,e,n,i,r){const{float32Array:o,uint16Array:a,uint32Array:l}=de;let c=s*2;if(De(c,a)){const u=un(s,l),d=yn(c,a);return qv(t,e,n,u,d,i,r)}else{const u=wc(s,l),d=rM[u],g=n.direction[d]>=0;let _,m;g?(_=Fe(s),m=Be(s,l)):(_=Be(s,l),m=Fe(s));const x=bi(_,o,n,i,r)?nc(_,t,e,n,i,r):null;if(x){const S=x.point[d];if(g?S<=o[m+u]:S>=o[m+u+3])return x}const y=bi(m,o,n,i,r)?nc(m,t,e,n,i,r):null;return x&&y?x.distance<=y.distance?x:y:x||y||null}}const fo=new ue,ps=new In,ms=new In,nr=new Et,Au=new Ke,po=new Ke;function aM(s,t,e,n){de.setBuffer(s._roots[t]);const i=ic(0,s,e,n);return de.clearBuffer(),i}function ic(s,t,e,n,i=null){const{float32Array:r,uint16Array:o,uint32Array:a}=de;let l=s*2;if(i===null&&(e.boundingBox||e.computeBoundingBox(),Au.set(e.boundingBox.min,e.boundingBox.max,n),i=Au),De(l,o)){const h=t.geometry,u=h.index,d=h.attributes.position,f=e.index,g=e.attributes.position,_=un(s,a),m=yn(l,o);if(nr.copy(n).invert(),e.boundsTree)return me(s,r,po),po.matrix.copy(nr),po.needsUpdate=!0,e.boundsTree.shapecast({intersectsBounds:x=>po.intersectsBox(x),intersectsTriangle:x=>{x.a.applyMatrix4(n),x.b.applyMatrix4(n),x.c.applyMatrix4(n),x.needsUpdate=!0;for(let M=_,y=m+_;M<y;M++)if(Te(ms,3*t.resolveTriangleIndex(M),u,d),ms.needsUpdate=!0,x.intersectsTriangle(ms))return!0;return!1}});{const p=Xi(e);for(let x=_,M=m+_;x<M;x++){const y=t.resolveTriangleIndex(x);Te(ps,3*y,u,d),ps.a.applyMatrix4(nr),ps.b.applyMatrix4(nr),ps.c.applyMatrix4(nr),ps.needsUpdate=!0;for(let S=0,E=p*3;S<E;S+=3)if(Te(ms,S,f,g),ms.needsUpdate=!0,ps.intersectsTriangle(ms))return!0}}}else{const h=Fe(s),u=Be(s,a);return me(h,r,fo),!!(i.intersectsBox(fo)&&ic(h,t,e,n,i)||(me(u,r,fo),i.intersectsBox(fo)&&ic(u,t,e,n,i)))}}const mo=new Et,Wa=new Ke,ir=new Ke,lM=new D,cM=new D,hM=new D,uM=new D;function dM(s,t,e,n={},i={},r=0,o=1/0){t.boundingBox||t.computeBoundingBox(),Wa.set(t.boundingBox.min,t.boundingBox.max,e),Wa.needsUpdate=!0;const a=s.geometry,l=a.attributes.position,c=a.index,h=t.attributes.position,u=t.index,d=xn.getPrimitive(),f=xn.getPrimitive();let g=lM,_=cM,m=null,p=null;i&&(m=hM,p=uM);let x=1/0,M=null,y=null;return mo.copy(e).invert(),ir.matrix.copy(mo),s.shapecast({boundsTraverseOrder:S=>Wa.distanceToBox(S),intersectsBounds:(S,E,A)=>A<x&&A<o?(E&&(ir.min.copy(S.min),ir.max.copy(S.max),ir.needsUpdate=!0),!0):!1,intersectsRange:(S,E)=>{if(t.boundsTree){const A=t.boundsTree;return A.shapecast({boundsTraverseOrder:R=>ir.distanceToBox(R),intersectsBounds:(R,v,b)=>b<x&&b<o,intersectsRange:(R,v)=>{for(let b=R,C=R+v;b<C;b++){const P=A.resolveTriangleIndex(b);Te(f,3*P,u,h),f.a.applyMatrix4(e),f.b.applyMatrix4(e),f.c.applyMatrix4(e),f.needsUpdate=!0;for(let L=S,N=S+E;L<N;L++){const z=s.resolveTriangleIndex(L);Te(d,3*z,c,l),d.needsUpdate=!0;const O=d.distanceToTriangle(f,g,m);if(O<x&&(_.copy(g),p&&p.copy(m),x=O,M=L,y=b),O<r)return!0}}}})}else{const A=Xi(t);for(let R=0,v=A;R<v;R++){Te(f,3*R,u,h),f.a.applyMatrix4(e),f.b.applyMatrix4(e),f.c.applyMatrix4(e),f.needsUpdate=!0;for(let b=S,C=S+E;b<C;b++){const P=s.resolveTriangleIndex(b);Te(d,3*P,c,l),d.needsUpdate=!0;const L=d.distanceToTriangle(f,g,m);if(L<x&&(_.copy(g),p&&p.copy(m),x=L,M=b,y=R),L<r)return!0}}}}}),xn.releasePrimitive(d),xn.releasePrimitive(f),x===1/0?null:(n.point?n.point.copy(_):n.point=_.clone(),n.distance=x,n.faceIndex=M,i&&(i.point?i.point.copy(p):i.point=p.clone(),i.point.applyMatrix4(mo),_.applyMatrix4(mo),i.distance=_.sub(i.point).length(),i.faceIndex=y),n)}function fM(){return typeof SharedArrayBuffer<"u"}const ur=new de.constructor,Uo=new de.constructor,_i=new Ac(()=>new ue),gs=new ue,_s=new ue,Xa=new ue,qa=new ue;let ja=!1;function pM(s,t,e,n){if(ja)throw new Error("MeshBVH: Recursive calls to bvhcast not supported.");ja=!0;const i=s._roots,r=t._roots;let o,a=0,l=0;const c=new Et().copy(e).invert();for(let h=0,u=i.length;h<u;h++){ur.setBuffer(i[h]),l=0;const d=_i.getPrimitive();me(0,ur.float32Array,d),d.applyMatrix4(c);for(let f=0,g=r.length;f<g&&(Uo.setBuffer(r[f]),o=bn(0,0,e,c,n,a,l,0,0,d),Uo.clearBuffer(),l+=r[f].byteLength/qe,!o);f++);if(_i.releasePrimitive(d),ur.clearBuffer(),a+=i[h].byteLength/qe,o)break}return ja=!1,o}function bn(s,t,e,n,i,r=0,o=0,a=0,l=0,c=null,h=!1){let u,d;h?(u=Uo,d=ur):(u=ur,d=Uo);const f=u.float32Array,g=u.uint32Array,_=u.uint16Array,m=d.float32Array,p=d.uint32Array,x=d.uint16Array,M=s*2,y=t*2,S=De(M,_),E=De(y,x);let A=!1;if(E&&S)h?A=i(un(t,p),yn(t*2,x),un(s,g),yn(s*2,_),l,o+t/Ie,a,r+s/Ie):A=i(un(s,g),yn(s*2,_),un(t,p),yn(t*2,x),a,r+s/Ie,l,o+t/Ie);else if(E){const R=_i.getPrimitive();me(t,m,R),R.applyMatrix4(e);const v=Fe(s),b=Be(s,g);me(v,f,gs),me(b,f,_s);const C=R.intersectsBox(gs),P=R.intersectsBox(_s);A=C&&bn(t,v,n,e,i,o,r,l,a+1,R,!h)||P&&bn(t,b,n,e,i,o,r,l,a+1,R,!h),_i.releasePrimitive(R)}else{const R=Fe(t),v=Be(t,p);me(R,m,Xa),me(v,m,qa);const b=c.intersectsBox(Xa),C=c.intersectsBox(qa);if(b&&C)A=bn(s,R,e,n,i,r,o,a,l+1,c,h)||bn(s,v,e,n,i,r,o,a,l+1,c,h);else if(b)if(S)A=bn(s,R,e,n,i,r,o,a,l+1,c,h);else{const P=_i.getPrimitive();P.copy(Xa).applyMatrix4(e);const L=Fe(s),N=Be(s,g);me(L,f,gs),me(N,f,_s);const z=P.intersectsBox(gs),O=P.intersectsBox(_s);A=z&&bn(R,L,n,e,i,o,r,l,a+1,P,!h)||O&&bn(R,N,n,e,i,o,r,l,a+1,P,!h),_i.releasePrimitive(P)}else if(C)if(S)A=bn(s,v,e,n,i,r,o,a,l+1,c,h);else{const P=_i.getPrimitive();P.copy(qa).applyMatrix4(e);const L=Fe(s),N=Be(s,g);me(L,f,gs),me(N,f,_s);const z=P.intersectsBox(gs),O=P.intersectsBox(_s);A=z&&bn(v,L,n,e,i,o,r,l,a+1,P,!h)||O&&bn(v,N,n,e,i,o,r,l,a+1,P,!h),_i.releasePrimitive(P)}}return A}const go=new Ke,wu=new ue,mM={strategy:Ad,maxDepth:40,maxLeafTris:10,useSharedArrayBuffer:!1,setBoundingBox:!0,onProgress:null,indirect:!1,verbose:!0,range:null};class qo{static serialize(t,e={}){e={cloneBuffers:!0,...e};const n=t.geometry,i=t._roots,r=t._indirectBuffer,o=n.getIndex(),a={version:1,roots:null,index:null,indirectBuffer:null};return e.cloneBuffers?(a.roots=i.map(l=>l.slice()),a.index=o?o.array.slice():null,a.indirectBuffer=r?r.slice():null):(a.roots=i,a.index=o?o.array:null,a.indirectBuffer=r),a}static deserialize(t,e,n={}){n={setIndex:!0,indirect:!!t.indirectBuffer,...n};const{index:i,roots:r,indirectBuffer:o}=t;t.version||(console.warn("MeshBVH.deserialize: Serialization format has been changed and will be fixed up. It is recommended to regenerate any stored serialized data."),l(r));const a=new qo(e,{...n,[ka]:!0});if(a._roots=r,a._indirectBuffer=o||null,n.setIndex){const c=e.getIndex();if(c===null){const h=new ce(t.index,1,!1);e.setIndex(h)}else c.array!==i&&(c.array.set(i),c.needsUpdate=!0)}return a;function l(c){for(let h=0;h<c.length;h++){const u=c[h],d=new Uint32Array(u),f=new Uint16Array(u);for(let g=0,_=u.byteLength/qe;g<_;g++){const m=Ie*g,p=2*m;De(p,f)||(d[m+6]=d[m+6]/Ie-g)}}}}get indirect(){return!!this._indirectBuffer}constructor(t,e={}){if(t.isBufferGeometry){if(t.index&&t.index.isInterleavedBufferAttribute)throw new Error("MeshBVH: InterleavedBufferAttribute is not supported for the index attribute.")}else throw new Error("MeshBVH: Only BufferGeometries are supported.");if(e=Object.assign({...mM,[ka]:!1},e),e.useSharedArrayBuffer&&!fM())throw new Error("MeshBVH: SharedArrayBuffer is not available.");this.geometry=t,this._roots=null,this._indirectBuffer=null,e[ka]||(Iv(this,e),!t.boundingBox&&e.setBoundingBox&&(t.boundingBox=this.getBoundingBox(new ue))),this.resolveTriangleIndex=e.indirect?n=>this._indirectBuffer[n]:n=>n}shiftTriangleOffsets(t){const e=this._indirectBuffer;if(e)for(let n=0,i=e.length;n<i;n++)e[n]+=t;else{const n=this._roots;for(let i=0;i<n.length;i++){const r=n[i],o=new Uint32Array(r),a=new Uint16Array(r),l=r.byteLength/qe;for(let c=0;c<l;c++){const h=Ie*c,u=2*h;De(u,a)&&(o[h+6]+=t)}}}}refit(t=null){return(this.indirect?iM:Wv)(this,t)}traverse(t,e=0){const n=this._roots[e],i=new Uint32Array(n),r=new Uint16Array(n);o(0);function o(a,l=0){const c=a*2,h=De(c,r);if(h){const u=i[a+6],d=r[c+14];t(l,h,new Float32Array(n,a*4,6),u,d)}else{const u=Fe(a),d=Be(a,i),f=wc(a,i);t(l,h,new Float32Array(n,a*4,6),f)||(o(u,l+1),o(d,l+1))}}}raycast(t,e=Rn,n=0,i=1/0){const r=this._roots,o=[],a=this.indirect?sM:Yv;for(let l=0,c=r.length;l<c;l++)a(this,l,e,t,o,n,i);return o}raycastFirst(t,e=Rn,n=0,i=1/0){const r=this._roots;let o=null;const a=this.indirect?oM:Zv;for(let l=0,c=r.length;l<c;l++){const h=a(this,l,e,t,n,i);h!=null&&(o==null||h.distance<o.distance)&&(o=h)}return o}intersectsGeometry(t,e){let n=!1;const i=this._roots,r=this.indirect?aM:Jv;for(let o=0,a=i.length;o<a&&(n=r(this,o,t,e),!n);o++);return n}shapecast(t){const e=xn.getPrimitive(),n=this.indirect?jv:Hv;let{boundsTraverseOrder:i,intersectsBounds:r,intersectsRange:o,intersectsTriangle:a}=t;if(o&&a){const u=o;o=(d,f,g,_,m)=>u(d,f,g,_,m)?!0:n(d,f,this,a,g,_,e)}else o||(a?o=(u,d,f,g)=>n(u,d,this,a,f,g,e):o=(u,d,f)=>f);let l=!1,c=0;const h=this._roots;for(let u=0,d=h.length;u<d;u++){const f=h[u];if(l=Bv(this,u,r,o,i,c),l)break;c+=f.byteLength/qe}return xn.releasePrimitive(e),l}bvhcast(t,e,n){let{intersectsRanges:i,intersectsTriangles:r}=n;const o=xn.getPrimitive(),a=this.geometry.index,l=this.geometry.attributes.position,c=this.indirect?g=>{const _=this.resolveTriangleIndex(g);Te(o,_*3,a,l)}:g=>{Te(o,g*3,a,l)},h=xn.getPrimitive(),u=t.geometry.index,d=t.geometry.attributes.position,f=t.indirect?g=>{const _=t.resolveTriangleIndex(g);Te(h,_*3,u,d)}:g=>{Te(h,g*3,u,d)};if(r){const g=(_,m,p,x,M,y,S,E)=>{for(let A=p,R=p+x;A<R;A++){f(A),h.a.applyMatrix4(e),h.b.applyMatrix4(e),h.c.applyMatrix4(e),h.needsUpdate=!0;for(let v=_,b=_+m;v<b;v++)if(c(v),o.needsUpdate=!0,r(o,h,v,A,M,y,S,E))return!0}return!1};if(i){const _=i;i=function(m,p,x,M,y,S,E,A){return _(m,p,x,M,y,S,E,A)?!0:g(m,p,x,M,y,S,E,A)}}else i=g}return pM(this,t,e,i)}intersectsBox(t,e){return go.set(t.min,t.max,e),go.needsUpdate=!0,this.shapecast({intersectsBounds:n=>go.intersectsBox(n),intersectsTriangle:n=>go.intersectsTriangle(n)})}intersectsSphere(t){return this.shapecast({intersectsBounds:e=>t.intersectsBox(e),intersectsTriangle:e=>e.intersectsSphere(t)})}closestPointToGeometry(t,e,n={},i={},r=0,o=1/0){return(this.indirect?dM:nM)(this,t,e,n,i,r,o)}closestPointToPoint(t,e={},n=0,i=1/0){return Ov(this,t,e,n,i)}getBoundingBox(t){return t.makeEmpty(),this._roots.forEach(n=>{me(0,new Float32Array(n),wu),t.union(wu)}),t}}const Ru=new ue,Cu=new Et;class gM extends pe{get isMesh(){return!this.displayEdges}get isLineSegments(){return this.displayEdges}get isLine(){return this.displayEdges}getVertexPosition(...t){return ye.prototype.getVertexPosition.call(this,...t)}constructor(t,e,n=10,i=0){super(),this.material=e,this.geometry=new ke,this.name="MeshBVHRootHelper",this.depth=n,this.displayParents=!1,this.bvh=t,this.displayEdges=!0,this._group=i}raycast(){}update(){const t=this.geometry,e=this.bvh,n=this._group;if(t.dispose(),this.visible=!1,e){const i=this.depth-1,r=this.displayParents;let o=0;e.traverse((d,f)=>{if(d>=i||f)return o++,!0;r&&o++},n);let a=0;const l=new Float32Array(24*o);e.traverse((d,f,g)=>{const _=d>=i||f;if(_||r){me(0,g,Ru);const{min:m,max:p}=Ru;for(let x=-1;x<=1;x+=2){const M=x<0?m.x:p.x;for(let y=-1;y<=1;y+=2){const S=y<0?m.y:p.y;for(let E=-1;E<=1;E+=2){const A=E<0?m.z:p.z;l[a+0]=M,l[a+1]=S,l[a+2]=A,a+=3}}}return _}},n);let c,h;this.displayEdges?h=new Uint8Array([0,4,1,5,2,6,3,7,0,2,1,3,4,6,5,7,0,1,2,3,4,5,6,7]):h=new Uint8Array([0,1,2,2,1,3,4,6,5,6,7,5,1,4,5,0,4,1,2,3,6,3,7,6,0,2,4,2,6,4,1,5,3,3,5,7]),l.length>65535?c=new Uint32Array(h.length*o):c=new Uint16Array(h.length*o);const u=h.length;for(let d=0;d<o;d++){const f=d*8,g=d*u;for(let _=0;_<u;_++)c[g+_]=f+h[_]}t.setIndex(new ce(c,1,!1)),t.setAttribute("position",new ce(l,3,!1)),this.visible=!0}}}class Rc extends yi{get color(){return this.edgeMaterial.color}get opacity(){return this.edgeMaterial.opacity}set opacity(t){this.edgeMaterial.opacity=t,this.meshMaterial.opacity=t}constructor(t=null,e=null,n=10){t instanceof qo&&(n=e||10,e=t,t=null),typeof e=="number"&&(n=e,e=null),super(),this.name="MeshBVHHelper",this.depth=n,this.mesh=t,this.bvh=e,this.displayParents=!1,this.displayEdges=!0,this.objectIndex=0,this._roots=[];const i=new yc({color:65416,transparent:!0,opacity:.3,depthWrite:!1}),r=new ii({color:65416,transparent:!0,opacity:.3,depthWrite:!1});r.color=i.color,this.edgeMaterial=i,this.meshMaterial=r,this.update()}update(){const t=this.mesh;let e=this.bvh||t.geometry.boundsTree||null;if(t&&t.isBatchedMesh&&t.boundsTrees&&!e){const i=t._drawInfo[this.objectIndex];i&&(e=t.boundsTrees[i.geometryIndex]||e)}const n=e?e._roots.length:0;for(;this._roots.length>n;){const i=this._roots.pop();i.geometry.dispose(),this.remove(i)}for(let i=0;i<n;i++){const{depth:r,edgeMaterial:o,meshMaterial:a,displayParents:l,displayEdges:c}=this;if(i>=this._roots.length){const u=new gM(e,o,r,i);this.add(u),this._roots.push(u)}const h=this._roots[i];h.bvh=e,h.depth=r,h.displayParents=l,h.displayEdges=c,h.material=c?o:a,h.update()}}updateMatrixWorld(...t){const e=this.mesh,n=this.parent;e!==null&&(e.updateWorldMatrix(!0,!1),n?this.matrix.copy(n.matrixWorld).invert().multiply(e.matrixWorld):this.matrix.copy(e.matrixWorld),(e.isInstancedMesh||e.isBatchedMesh)&&(e.getMatrixAt(this.objectIndex,Cu),this.matrix.multiply(Cu)),this.matrix.decompose(this.position,this.quaternion,this.scale)),super.updateMatrixWorld(...t)}copy(t){this.depth=t.depth,this.mesh=t.mesh,this.bvh=t.bvh,this.opacity=t.opacity,this.color.copy(t.color)}clone(){return new Rc(this.mesh,this.bvh,this.depth)}dispose(){this.edgeMaterial.dispose(),this.meshMaterial.dispose();const t=this.children;for(let e=0,n=t.length;e<n;e++)t[e].geometry.dispose()}}function Pu(s,t,e){return s===null?null:(s.point.applyMatrix4(t.matrixWorld),s.distance=s.point.distanceTo(e.ray.origin),s.object=t,s)}const _o=new Wi,Iu=new D,Du=new Et,_M=ye.prototype.raycast,xM=wp.prototype.raycast,Lu=new D,Le=new ye,xo=[];function yM(s,t){this.isBatchedMesh?vM.call(this,s,t):MM.call(this,s,t)}function vM(s,t){if(this.boundsTrees){const e=this.boundsTrees,n=this._drawInfo||this._instanceInfo,i=this._drawRanges||this._geometryInfo,r=this.matrixWorld;Le.material=this.material,Le.geometry=this.geometry;const o=Le.geometry.boundsTree,a=Le.geometry.drawRange;Le.geometry.boundingSphere===null&&(Le.geometry.boundingSphere=new Ye);for(let l=0,c=n.length;l<c;l++){if(!this.getVisibleAt(l))continue;const h=n[l].geometryIndex;if(Le.geometry.boundsTree=e[h],this.getMatrixAt(l,Le.matrixWorld).premultiply(r),!Le.geometry.boundsTree){this.getBoundingBoxAt(h,Le.geometry.boundingBox),this.getBoundingSphereAt(h,Le.geometry.boundingSphere);const u=i[h];Le.geometry.setDrawRange(u.start,u.count)}Le.raycast(s,xo);for(let u=0,d=xo.length;u<d;u++){const f=xo[u];f.object=this,f.batchId=l,t.push(f)}xo.length=0}Le.geometry.boundsTree=o,Le.geometry.drawRange=a,Le.material=null,Le.geometry=null}else xM.call(this,s,t)}function MM(s,t){if(this.geometry.boundsTree){if(this.material===void 0)return;Du.copy(this.matrixWorld).invert(),_o.copy(s.ray).applyMatrix4(Du),Lu.setFromMatrixScale(this.matrixWorld),Iu.copy(_o.direction).multiply(Lu);const e=Iu.length(),n=s.near/e,i=s.far/e,r=this.geometry.boundsTree;if(s.firstHitOnly===!0){const o=Pu(r.raycastFirst(_o,this.material,n,i),this,s);o&&t.push(o)}else{const o=r.raycast(_o,this.material,n,i);for(let a=0,l=o.length;a<l;a++){const c=Pu(o[a],this,s);c&&t.push(c)}}}else _M.call(this,s,t)}const sr=new D;function mn(s,t,e,n,i,r){const o=2*Math.PI*i/4,a=Math.max(r-2*i,0),l=Math.PI/4;sr.copy(t),sr[n]=0,sr.normalize();const c=.5*o/(o+a),h=1-sr.angleTo(s)/l;return Math.sign(sr[e])===1?h*c:a/(o+a)+c+c*(1-h)}class Cc extends Us{constructor(t=1,e=1,n=1,i=2,r=.1){const o=i*2+1;if(r=Math.min(t/2,e/2,n/2,r),super(1,1,1,o,o,o),this.type="RoundedBoxGeometry",this.parameters={width:t,height:e,depth:n,segments:i,radius:r},o===1)return;const a=this.toNonIndexed();this.index=null,this.attributes.position=a.attributes.position,this.attributes.normal=a.attributes.normal,this.attributes.uv=a.attributes.uv;const l=new D,c=new D,h=new D(t,e,n).divideScalar(2).subScalar(r),u=this.attributes.position.array,d=this.attributes.normal.array,f=this.attributes.uv.array,g=u.length/6,_=new D,m=.5/o;for(let p=0,x=0;p<u.length;p+=3,x+=2)switch(l.fromArray(u,p),c.copy(l),c.x-=Math.sign(c.x)*m,c.y-=Math.sign(c.y)*m,c.z-=Math.sign(c.z)*m,c.normalize(),u[p+0]=h.x*Math.sign(l.x)+c.x*r,u[p+1]=h.y*Math.sign(l.y)+c.y*r,u[p+2]=h.z*Math.sign(l.z)+c.z*r,d[p+0]=c.x,d[p+1]=c.y,d[p+2]=c.z,Math.floor(p/g)){case 0:_.set(1,0,0),f[x+0]=mn(_,c,"z","y",r,n),f[x+1]=1-mn(_,c,"y","z",r,e);break;case 1:_.set(-1,0,0),f[x+0]=1-mn(_,c,"z","y",r,n),f[x+1]=1-mn(_,c,"y","z",r,e);break;case 2:_.set(0,1,0),f[x+0]=1-mn(_,c,"x","z",r,t),f[x+1]=mn(_,c,"z","x",r,n);break;case 3:_.set(0,-1,0),f[x+0]=1-mn(_,c,"x","z",r,t),f[x+1]=1-mn(_,c,"z","x",r,n);break;case 4:_.set(0,0,1),f[x+0]=1-mn(_,c,"x","y",r,t),f[x+1]=1-mn(_,c,"y","x",r,e);break;case 5:_.set(0,0,-1),f[x+0]=mn(_,c,"x","y",r,t),f[x+1]=1-mn(_,c,"y","x",r,e);break}}static fromJSON(t){return new Cc(t.width,t.height,t.depth,t.segments,t.radius)}}const SM="/three-player-controller/assets/fly-D71dHlOE.png",bM="data:image/png;base64,",TM="/three-player-controller/assets/view-DEoCKGng.png";ye.prototype.raycast=yM;let wo=null;const EM=new em;class AM{constructor(){this.loader=new Dy,this.playerRadius=45,this.playerHeight=180,this.isFirstPerson=!1,this.boundingBoxMinY=0,this.displayPlayer=!1,this.displayCollider=!1,this.displayVisualizer=!1,this.collider=null,this.visualizer=null,this.person=null,this.playerIsOnGround=!1,this.isupdate=!0,this.isFlying=!1,this.fwdPressed=!1,this.bkdPressed=!1,this.lftPressed=!1,this.rgtPressed=!1,this.spacePressed=!1,this.ctPressed=!1,this.shiftPressed=!1,this.prevJoyState={dirX:0,dirY:0,shift:!1},this.nippleModule=null,this.joystickManager=null,this.joystickZoneEl=null,this.lookAreaEl=null,this.jumpBtnEl=null,this.flyBtnEl=null,this.viewBtnEl=null,this.lookPointerId=null,this.isLookDown=!1,this.lastTouchX=0,this.lastTouchY=0,this._camCollisionLerp=.18,this._camEpsilon=.35,this._minCamDistance=1,this._maxCamDistance=4.4,this.orginMaxCamDistance=4.4,this.playerVelocity=new D,this.upVector=new D(0,1,0),this.tempVector=new D,this.tempVector2=new D,this.tempBox=new ue,this.tempMat=new Et,this.tempSegment=new Pn,this.recheckAnimTimer=null,this.camDir=new D,this.moveDir=new D,this.targetQuat=new nn,this.targetMat=new Et,this.rotationSpeed=10,this.DIR_FWD=new D(0,0,-1),this.DIR_BKD=new D(0,0,1),this.DIR_LFT=new D(-1,0,0),this.DIR_RGT=new D(1,0,0),this.DIR_UP=new D(0,1,0),this._personToCam=new D,this._originTmp=new D,this._raycaster=new Ch(new D,new D(0,-1,0)),this._raycasterPersonToCam=new Ch(new D,new D),this.setAnimationByPressed=()=>{if(this._maxCamDistance=this.orginMaxCamDistance,this.isFlying){if(!this.fwdPressed){this.playPersonAnimationByName("flyidle");return}this.playPersonAnimationByName("flying"),this._maxCamDistance=this.orginMaxCamDistance*2;return}if(this.playerIsOnGround){if(!this.fwdPressed&&!this.bkdPressed&&!this.lftPressed&&!this.rgtPressed){this.playPersonAnimationByName("idle");return}if(this.fwdPressed){this.playPersonAnimationByName(this.shiftPressed?"running":"walking");return}if(!this.isFirstPerson&&(this.lftPressed||this.rgtPressed||this.bkdPressed)){this.playPersonAnimationByName(this.shiftPressed?"running":"walking");return}if(this.lftPressed){this.playPersonAnimationByName("left_walking");return}if(this.rgtPressed){this.playPersonAnimationByName("right_walking");return}if(this.bkdPressed){this.playPersonAnimationByName("walking_backward");return}}this.recheckAnimTimer!==null&&clearTimeout(this.recheckAnimTimer),this.recheckAnimTimer=setTimeout(()=>{this.setAnimationByPressed(),this.recheckAnimTimer=null},200)},this._boundOnKeydown=async t=>{switch(t.ctrlKey&&["KeyW","KeyA","KeyS","KeyD"].includes(t.code)&&t.preventDefault(),t.code){case"KeyW":this.fwdPressed=!0,this.setAnimationByPressed();break;case"KeyS":this.bkdPressed=!0,this.setAnimationByPressed();break;case"KeyD":this.rgtPressed=!0,this.setAnimationByPressed();break;case"KeyA":this.lftPressed=!0,this.setAnimationByPressed();break;case"ShiftLeft":this.shiftPressed=!0,this.setAnimationByPressed(),this.controls.mouseButtons={LEFT:2,MIDDLE:1,RIGHT:0};break;case"Space":if(this.spacePressed=!0,!this.playerIsOnGround||this.isFlying)return;const e=this.personActions?.get("jumping");if(e&&this.actionState===e)return;this.playPersonAnimationByName("jumping"),this.playerVelocity.y=this.jumpHeight,this.playerIsOnGround=!1;break;case"ControlLeft":this.ctPressed=!0;break;case"KeyV":this.changeView();break;case"KeyF":this.isFlying=!this.isFlying,this.setAnimationByPressed(),!this.isFlying&&!this.playerIsOnGround&&this.playPersonAnimationByName("jumping");break}},this._boundOnKeyup=t=>{switch(t.code){case"KeyW":this.fwdPressed=!1,this.setAnimationByPressed();break;case"KeyS":this.bkdPressed=!1,this.setAnimationByPressed();break;case"KeyD":this.rgtPressed=!1,this.setAnimationByPressed();break;case"KeyA":this.lftPressed=!1,this.setAnimationByPressed();break;case"ShiftLeft":this.shiftPressed=!1,this.setAnimationByPressed(),this.controls.mouseButtons={LEFT:0,MIDDLE:1,RIGHT:2};break;case"Space":this.spacePressed=!1;break;case"ControlLeft":this.ctPressed=!1;break}},this._mouseMove=t=>{document.pointerLockElement===document.body&&this.setToward(t.movementX,t.movementY,1e-4)},this._mouseClick=t=>{this.setPointerLock()},this.onPointerDown=t=>{t.pointerType==="touch"&&(this.isLookDown=!0,this.lookPointerId=t.pointerId,this.lastTouchX=t.clientX,this.lastTouchY=t.clientY,this.lookAreaEl?.setPointerCapture?.(t.pointerId),t.preventDefault())},this.onPointerMove=t=>{if(!this.isLookDown||t.pointerId!==this.lookPointerId)return;const e=t.clientX-this.lastTouchX,n=t.clientY-this.lastTouchY;this.lastTouchX=t.clientX,this.lastTouchY=t.clientY,this.setInput({lookDeltaX:e,lookDeltaY:n}),t.preventDefault()},this.onPointerUp=t=>{t.pointerId===this.lookPointerId&&(this.isLookDown=!1,this.lookPointerId=null,this.lookAreaEl?.releasePointerCapture?.(t.pointerId))},this._raycaster.firstHitOnly=!0,this._raycasterPersonToCam.firstHitOnly=!0}async init(t,e){this.scene=t.scene,this.camera=t.camera,this.camera.rotation.order="YXZ",this.controls=t.controls,this.playerModel=t.playerModel,this.initPos=t.initPos??new D(0,0,0),this.mouseSensity=t.mouseSensity??5;const n=this.playerModel.scale;this.visualizeDepth=0*n,this.gravity=(t.playerModel.gravity??-2400)*n,this.jumpHeight=(t.playerModel.jumpHeight??800)*n,this.originPlayerSpeed=(t.playerModel.speed??400)*n,this.playerSpeed=this.originPlayerSpeed,this.playerModel.rotateY=t.playerModel.rotateY??0,this._camCollisionLerp=.18,this._camEpsilon=35*n,this._minCamDistance=(t.minCamDistance??100)*n,this._maxCamDistance=(t.maxCamDistance??440)*n,this.orginMaxCamDistance=this._maxCamDistance,this.thirdMouseMode=t.thirdMouseMode??1;const i=()=>navigator.maxTouchPoints&&navigator.maxTouchPoints>0||"ontouchstart"in window||/Mobi|Android|iPhone|iPad|iPod/i.test(navigator.userAgent);this.isShowMobileControls=(t.isShowMobileControls??!0)&&i(),this.isShowMobileControls&&await this.initMobileControls(),await this.createBVH(t.colliderMeshUrl),this.createPlayer(),await this.loadPersonGLB(),this.isFirstPerson&&this.person&&this.person.add(this.camera),this.onAllEvent(),this.setCameraPos(),this.setControls(),e&&e()}async initLoader(){const t=new Cy;t.setDecoderPath("https://unpkg.com/three@0.180.0/examples/jsm/libs/draco/gltf/"),t.setDecoderConfig({type:"js"}),this.loader.setDRACOLoader(t)}async loadPersonGLB(){try{const t=await this.loader.loadAsync(this.playerModel.url);this.person=t.scene;const e=this.playerModel.scale,n=this.playerHeight*e;this.person.scale.set(e,e,e),this.person.position.set(0,-n*.75,0),this.person.traverse(a=>{a.isMesh&&(a.castShadow=!0,a.receiveShadow=!0)}),this.player.add(this.person),this.reset(),this.personMixer=new pm(this.person);const i=t.animations??[];this.personActions=new Map;const r=[[this.playerModel.idleAnim,"idle"],[this.playerModel.walkAnim,"walking"],[this.playerModel.leftWalkAnim||this.playerModel.walkAnim,"left_walking"],[this.playerModel.rightWalkAnim||this.playerModel.walkAnim,"right_walking"],[this.playerModel.backwardAnim||this.playerModel.walkAnim,"walking_backward"],[this.playerModel.jumpAnim,"jumping"],[this.playerModel.runAnim,"running"],[this.playerModel.flyIdleAnim||this.playerModel.idleAnim,"flyidle"],[this.playerModel.flyAnim||this.playerModel.idleAnim,"flying"]],o=a=>i.find(l=>l.name===a);for(const[a,l]of r){const c=o(a);if(!c)continue;const h=this.personMixer.clipAction(c);l==="jumping"?(h.setLoop(Zu,1),h.clampWhenFinished=!0,h.setEffectiveTimeScale(1.2)):(h.setLoop(Ju,1/0),h.clampWhenFinished=!1,h.setEffectiveTimeScale(1)),h.enabled=!0,h.setEffectiveWeight(0),this.personActions.set(l,h)}this.idleAction=this.personActions.get("idle"),this.walkAction=this.personActions.get("walking"),this.leftWalkAction=this.personActions.get("left_walking"),this.rightWalkAction=this.personActions.get("right_walking"),this.backwardAction=this.personActions.get("walking_backward"),this.jumpAction=this.personActions.get("jumping"),this.runAction=this.personActions.get("running"),this.flyidleAction=this.personActions.get("flyidle"),this.flyAction=this.personActions.get("flying"),this.idleAction.setEffectiveWeight(1),this.idleAction.play(),this.actionState=this.idleAction,this.personMixer.addEventListener("finished",a=>{if(a.action===this.jumpAction){if(this.fwdPressed){this.playPersonAnimationByName(this.shiftPressed?"running":"walking");return}if(this.bkdPressed){this.playPersonAnimationByName("walking_backward");return}if(this.rgtPressed||this.lftPressed){this.playPersonAnimationByName("walking");return}this.playPersonAnimationByName("idle")}})}catch(t){console.error("加载玩家模型失败:",t)}}playPersonAnimationByName(t,e=.18){if(!this.personActions||this.ctPressed)return;const n=this.personActions.get(t);if(!n||this.actionState===n)return;const i=this.actionState;n.reset(),n.setEffectiveWeight(1),n.play(),i&&i!==n&&i.fadeOut(e),n.fadeIn(e),this.actionState=n}createPlayer(){const t=new zo({color:new Nt(1,0,0),shadowSide:_n,depthTest:!1,transparent:!0,opacity:this.displayPlayer?.5:0,wireframe:!0,depthWrite:!1}),e=this.playerRadius*this.playerModel.scale,n=this.playerHeight*this.playerModel.scale;this.player=new ye(new Cc(e*2,n,e*2,1,75),t),this.player.geometry.translate(0,-n*.25,0),this.player.capsuleInfo={radius:e,segment:new Pn(new D,new D(0,-n*.5,0))},this.player.name="capsule",this.scene.add(this.player),this.reset(),this.player.rotateY(this.playerModel.rotateY??0)}changeView(){if(this.isFirstPerson=!this.isFirstPerson,this.isFirstPerson)this.player.attach(this.camera),this.camera.position.set(0,40*this.playerModel.scale,30*this.playerModel.scale),this.camera.rotation.set(0,Math.PI,0);else{this.scene.attach(this.camera);const t=this.player.position.clone(),e=new D(0,0,-1).applyQuaternion(this.player.quaternion),n=Math.atan2(e.z,e.x),i=new D(Math.cos(n)*400*this.playerModel.scale,200*this.playerModel.scale,Math.sin(n)*400*this.playerModel.scale);this.camera.position.copy(t).add(i),this.controls.target.copy(t)}this.setPointerLock()}setPointerLock(){((this.thirdMouseMode===0||this.thirdMouseMode===1)&&!this.isFirstPerson||this.isFirstPerson)&&document.body.requestPointerLock()}setCameraPos(){if(this.isFirstPerson)this.camera.position.set(0,40*this.playerModel.scale,30*this.playerModel.scale);else{const t=this.player.position.clone(),e=new D(0,0,-1).applyQuaternion(this.player.quaternion),n=Math.atan2(e.z,e.x),i=new D(Math.cos(n)*400*this.playerModel.scale,-100*this.playerModel.scale,Math.sin(n)*400*this.playerModel.scale);this.camera.position.copy(t).add(i)}this.camera.updateProjectionMatrix()}setControls(){this.controls.enabled=!(this.thirdMouseMode===0||this.thirdMouseMode===1),this.controls.rotateSpeed=this.mouseSensity*.05,this.controls.maxPolarAngle=Math.PI*(300/360)}resetControls(){this.controls&&(this.controls.enabled=!0,this.controls.enablePan=!0,this.controls.maxPolarAngle=Math.PI/2,this.controls.rotateSpeed=1,this.controls.enableZoom=!0,this.controls.mouseButtons={LEFT:0,MIDDLE:1,RIGHT:2})}setToward(t,e,n){if(this.isFirstPerson){const i=-t*n*this.mouseSensity,r=-e*n*this.mouseSensity;this.player.rotateY(i),this.camera.rotation.x=pc.clamp(this.camera.rotation.x+r,-1.1,1.4)}else{const i=this.mouseSensity,r=-t*n*i,o=-e*n*i,a=this.player.position.clone(),l=this.camera.position.distanceTo(a),c=this.camera.position.clone().sub(a);let h=Math.atan2(c.x,c.z),u=Math.acos(c.y/l);h+=r,u+=o,u=Math.max(.1,Math.min(Math.PI-.1,u));const d=l*Math.sin(u)*Math.sin(h),f=l*Math.cos(u),g=l*Math.sin(u)*Math.cos(h);this.camera.position.set(a.x+d,a.y+f,a.z+g),this.camera.lookAt(a)}}async createBVH(t=""){await this.initLoader();const e=r=>{if(!r.attributes.position)return null;if(r.attributes.normal||r.computeVertexNormals(),!r.attributes.uv){const o=r.attributes.position.count,a=new Float32Array(o*2);r.setAttribute("uv",new ce(a,2))}return r},n=[];if(t===""){if(this.collider&&(this.scene.remove(this.collider),this.collider=null),this.scene.traverse(l=>{const c=l;if(c?.isMesh&&c.geometry&&l.name!=="capsule")try{let h=c.geometry.clone();h.applyMatrix4(c.matrixWorld),h.index&&(h=h.toNonIndexed());const u=e(h);u&&n.push(u)}catch(h){console.warn("处理网格时出错：",c,h)}}),!n.length)return;const r=new Map,o=new Set;for(const l of n)for(const c of Object.keys(l.attributes)){const h=l.attributes[c],u=h.array.constructor,d=h.itemSize;if(!r.has(c))r.set(c,{itemSize:d,arrayCtor:u,examples:1});else{const f=r.get(c);f.itemSize!==d||f.arrayCtor!==u?o.add(c):f.examples++}}if(o.size){for(const l of n)for(const c of Array.from(o))l.attributes[c]&&l.deleteAttribute(c);for(const l of o)r.delete(l)}const a=Array.from(r.keys());for(const l of n){const c=l.attributes.position.count;for(const h of a)if(!l.attributes[h]){const u=r.get(h),d=c*u.itemSize,f=new u.arrayCtor(d);l.setAttribute(h,new ce(f,u.itemSize))}}}else{const o=(await this.loader.loadAsync(t)).scene.children[0];o.name="BVH加载模型";let a=o.geometry.clone();a.applyMatrix4(o.matrixWorld),a.index&&(a=a.toNonIndexed());const l=e(a);l&&n.push(l)}const i=Iy(n,!1);if(!i){console.error("合并几何失败");return}i.boundsTree=new qo(i,{maxDepth:100}),this.collider=new ye(i,new ii({opacity:.5,transparent:!0,wireframe:!0})),this.displayCollider&&this.scene.add(this.collider),this.displayVisualizer&&(this.visualizer&&this.scene.remove(this.visualizer),this.visualizer=new Rc(this.collider,this.visualizeDepth),this.scene.add(this.visualizer)),this.boundingBoxMinY=this.collider.geometry.boundingBox.min.y}getAngleWithYAxis(t){const e={x:0,y:1,z:0},n=t.x*e.x+t.y*e.y+t.z*e.z,i=Math.sqrt(t.x*t.x+t.y*t.y+t.z*t.z),r=n/i;return Math.acos(r)}async update(t=EM.getDelta()){if(!this.isupdate||!this.player||!this.collider)return;t=Math.min(t,1/30),this.isFlying||this.player.position.addScaledVector(this.playerVelocity,t),this.updateMixers(t),this.camera.getWorldDirection(this.camDir);let e=Math.atan2(this.camDir.z,this.camDir.x)+Math.PI/2;e=2*Math.PI-e,this.moveDir.set(0,0,0),this.fwdPressed&&this.moveDir.add(this.DIR_FWD),this.bkdPressed&&this.moveDir.add(this.DIR_BKD),this.lftPressed&&this.moveDir.add(this.DIR_LFT),this.rgtPressed&&this.moveDir.add(this.DIR_RGT),this.isFlying&&(this.fwdPressed?this.moveDir.y=this.camDir.y:this.moveDir.y=0,this.spacePressed&&this.moveDir.add(this.DIR_UP)),this.isFlying&&this.fwdPressed?this.playerSpeed=this.shiftPressed?this.originPlayerSpeed*12:this.originPlayerSpeed*7:this.playerSpeed=this.shiftPressed?this.originPlayerSpeed*2:this.originPlayerSpeed,this.moveDir.normalize().applyAxisAngle(this.upVector,e),this.player.position.addScaledVector(this.moveDir,this.playerSpeed*t);let n=1/0;this._originTmp.set(this.player.position.x,this.player.position.y,this.player.position.z),this._raycaster.ray.origin.copy(this._originTmp);const i=this._raycaster.intersectObject(this.collider,!1);if(i.length>0){n=this.player.position.y-i[0].point.y;const h=i[0].normal,u=this.getAngleWithYAxis(h)*180/Math.PI,d=this.playerHeight*this.playerModel.scale*.9,f=this.playerHeight*this.playerModel.scale*.75,g=this.playerHeight*this.playerModel.scale*.7;this.isFlying||(n>d?(this.playerVelocity.y+=t*this.gravity,this.player.position.addScaledVector(this.playerVelocity,t),this.playerIsOnGround=!1):n>f&&n<d?u>=0&&u<5?(this.playerVelocity.y+=t*this.gravity,this.player.position.addScaledVector(this.playerVelocity,t),this.playerIsOnGround=!0):(this.playerVelocity.set(0,0,0),this.playerIsOnGround=!0):n>g&&n<f?(this.playerVelocity.set(0,0,0),this.playerIsOnGround=!0):n<g&&(this.playerVelocity.set(0,0,0),this.player.position.set(this.player.position.x,i[0].point.y+f,this.player.position.z),this.playerIsOnGround=!0))}this.player.updateMatrixWorld();const r=this.player.capsuleInfo;this.tempBox.makeEmpty(),this.tempMat.copy(this.collider.matrixWorld).invert(),this.tempSegment.copy(r.segment),this.tempSegment.start.applyMatrix4(this.player.matrixWorld).applyMatrix4(this.tempMat),this.tempSegment.end.applyMatrix4(this.player.matrixWorld).applyMatrix4(this.tempMat),this.tempBox.expandByPoint(this.tempSegment.start),this.tempBox.expandByPoint(this.tempSegment.end),this.tempBox.expandByScalar(r.radius),this.collider?.geometry?.boundsTree?.shapecast({intersectsBounds:h=>h.intersectsBox(this.tempBox),intersectsTriangle:h=>{const u=this.tempVector,d=this.tempVector2,f=h.closestPointToSegment(this.tempSegment,u,d);if(f<r.radius){const g=r.radius-f,_=d.sub(u).normalize();this.tempSegment.start.addScaledVector(_,g),this.tempSegment.end.addScaledVector(_,g)}}});const a=this.tempVector.copy(this.tempSegment.start).applyMatrix4(this.collider.matrixWorld),l=this.tempVector2.subVectors(a,this.player.position),c=Math.max(0,l.length()-1e-5);if(l.normalize().multiplyScalar(c),this.player.position.add(l),!this.isFirstPerson&&!this.isFlying){this.camDir.y=0,this.camDir.normalize(),this.camDir.negate(),this.moveDir.normalize(),this.moveDir.negate();let h;if(this.thirdMouseMode===0||this.thirdMouseMode===2){this.moveDir.lengthSq()>0?h=this.player.position.clone().add(this.moveDir):h=this.player.position.clone().add(this.camDir),this.targetMat.lookAt(this.player.position,h,this.player.up),this.targetQuat.setFromRotationMatrix(this.targetMat);const u=Math.min(1,this.rotationSpeed*t);this.player.quaternion.slerp(this.targetQuat,u)}if((this.thirdMouseMode===1||this.thirdMouseMode===3)&&this.moveDir.lengthSq()>0){h=this.player.position.clone().add(this.moveDir),this.targetMat.lookAt(this.player.position,h,this.player.up),this.targetQuat.setFromRotationMatrix(this.targetMat);const u=Math.min(1,this.rotationSpeed*t);this.player.quaternion.slerp(this.targetQuat,u)}}if(this.isFlying){this.camDir.y=0,this.camDir.normalize(),this.camDir.negate(),this.moveDir.normalize(),this.moveDir.negate();const h=this.player.position.clone().add(this.fwdPressed?this.moveDir:this.camDir);this.targetMat.lookAt(this.player.position,h,this.player.up),this.targetQuat.setFromRotationMatrix(this.targetMat);const u=Math.min(1,this.rotationSpeed*t);this.player.quaternion.slerp(this.targetQuat,u)}if(!this.isFirstPerson){const h=this.player.position.clone();h.y+=30*this.playerModel.scale,this.camera.position.sub(this.controls.target),this.controls.target.copy(h),this.camera.position.add(h),this.controls.update(),this._personToCam.subVectors(this.camera.position,this.player.position);const u=this.player.position.clone().add(new D(0,0,0)),d=this._personToCam.clone().normalize(),f=this._personToCam.length();this._raycasterPersonToCam.set(u,d),this._raycasterPersonToCam.far=f;const g=this._raycasterPersonToCam.intersectObject(this.collider,!1);if(g.length>0){const _=g[0],m=Math.max(_.distance-this._camEpsilon,this._minCamDistance),p=u.clone().add(d.clone().multiplyScalar(m));this.camera.position.lerp(p,this._camCollisionLerp)}else{this._raycasterPersonToCam.far=this._maxCamDistance;const _=this._raycasterPersonToCam.intersectObject(this.collider,!1);let m=this._maxCamDistance;_.length&&(m=_[0].distance-this._camEpsilon);const p=u.clone().add(d.clone().multiplyScalar(m));this.camera.position.lerp(p,this._camCollisionLerp)}}if(this.player.position.y<this.boundingBoxMinY-1){this._originTmp.set(this.player.position.x,1e4,this.player.position.z),this._raycaster.ray.origin.copy(this._originTmp);const h=this._raycaster.intersectObject(this.collider,!1);h.length>0?(console.log("玩家为bug意外掉落"),this.reset(new D(this.player.position.x,h[0].point.y+5,this.player.position.z))):(console.log("玩家正常掉落"),this.reset(new D(this.player.position.x,this.player.position.y+15,this.player.position.z)))}}updateMixers(t){this.personMixer&&this.personMixer.update(t)}reset(t){this.player&&(this.playerVelocity.set(0,0,0),this.player.position.copy(t??this.initPos))}getPosition(){return this.player.position}setInput(t){if(typeof t.moveX=="number"&&(this.lftPressed=t.moveX===-1,this.rgtPressed=t.moveX===1,this.setAnimationByPressed()),typeof t.moveY=="number"&&(this.fwdPressed=t.moveY===1,this.bkdPressed=t.moveY===-1,this.setAnimationByPressed()),typeof t.lookDeltaX=="number"&&typeof t.lookDeltaY=="number"&&this.setToward(t.lookDeltaX,t.lookDeltaY,.002),typeof t.jump=="boolean")if(t.jump){if(this.spacePressed=!0,!this.playerIsOnGround||this.isFlying)return;this.playPersonAnimationByName("jumping"),this.playerVelocity.y=this.jumpHeight,this.playerIsOnGround=!1}else this.spacePressed=!1;typeof t.shift=="boolean"&&(this.shiftPressed=t.shift),t.toggleView&&this.changeView(),t.toggleFly&&(this.isFlying=!this.isFlying,this.setAnimationByPressed(),!this.isFlying&&!this.playerIsOnGround&&this.playPersonAnimationByName("jumping"))}onAllEvent(){this.isupdate=!0,this.setPointerLock(),window.addEventListener("keydown",this._boundOnKeydown),window.addEventListener("keyup",this._boundOnKeyup),window.addEventListener("mousemove",this._mouseMove),window.addEventListener("click",this._mouseClick)}offAllEvent(){this.isupdate=!1,document.exitPointerLock(),window.removeEventListener("keydown",this._boundOnKeydown),window.removeEventListener("keyup",this._boundOnKeyup),window.removeEventListener("mousemove",this._mouseMove),window.removeEventListener("click",this._mouseClick)}async initMobileControls(){this.controls.maxPolarAngle=Math.PI*(300/360),this.controls.touches={ONE:null,TWO:null},this.nippleModule=await mv(()=>import("./index-Dl0pyd0J.js"),[]);const t=this.nippleModule?.default,e=120,n=document.body;this.joystickZoneEl=document.createElement("div"),this.joystickZoneEl.id="joy-zone",Object.assign(this.joystickZoneEl.style,{position:"absolute",left:"16px",bottom:"16px",width:`${e+40}px`,height:`${e+40}px`,touchAction:"none",zIndex:"999",pointerEvents:"auto",WebkitUserSelect:"none",userSelect:"none"}),n.appendChild(this.joystickZoneEl),["touchstart","touchmove","touchend","touchcancel"].forEach(r=>{this.joystickZoneEl?.addEventListener(r,o=>o.preventDefault(),{passive:!1})}),this.joystickManager=t.create({zone:this.joystickZoneEl,mode:"static",position:{left:`${(e+40)/2}px`,bottom:`${(e+40)/2}px`},color:"#ffffff",size:e,multitouch:!0,maxNumberOfNipples:1}),this.joystickManager.on("move",(r,o)=>{if(!o)return;const a=o.vector?.x??0,l=o.vector?.y??0,c=o.distance??0,h=.5,u=a>h?1:a<-h?-1:0,d=l>h?1:l<-h?-1:0,f=e/2,g=c>=f,_=this.prevJoyState||{dirX:0,dirY:0,shift:!1};u===_.dirX&&d===_.dirY&&g===_.shift||(this.prevJoyState={dirX:u,dirY:d,shift:g},this.setInput({moveX:u,moveY:d,shift:g}))}),this.joystickManager.on("end",()=>{const r=this.prevJoyState||{dirX:0,dirY:0,shift:!1};(r.dirX!==0||r.dirY!==0||r.shift!==!1)&&(this.prevJoyState={dirX:0,dirY:0,shift:!1},this.setInput({moveX:0,moveY:0,shift:!1}))}),this.lookAreaEl=document.createElement("div"),Object.assign(this.lookAreaEl.style,{position:"absolute",right:"0",bottom:"0",width:"50%",height:"100%",zIndex:"998",touchAction:"none",WebkitUserSelect:"none",userSelect:"none"}),n.appendChild(this.lookAreaEl),["touchstart","touchmove","touchend","touchcancel"].forEach(r=>{this.lookAreaEl?.addEventListener(r,o=>o.preventDefault(),{passive:!1})}),this.lookAreaEl.addEventListener("pointerdown",this.onPointerDown,{passive:!1}),this.lookAreaEl.addEventListener("pointermove",this.onPointerMove,{passive:!1}),this.lookAreaEl.addEventListener("pointerup",this.onPointerUp,{passive:!1}),this.lookAreaEl.addEventListener("pointercancel",this.onPointerUp,{passive:!1});const i=(r,o,a)=>{const l=document.createElement("button"),c={position:"absolute",right:`${r}px`,bottom:`${o}px`,width:"56px",height:"56px",zIndex:"1000",borderRadius:"50%",border:"2px solid black",background:"rgba(0,0,0)",padding:"20px",opacity:"0.95",touchAction:"none",fontSize:"14px",userSelect:"none",overflow:"hidden",boxSizing:"border-box",backgroundColor:"transparent",backgroundRepeat:"no-repeat, no-repeat",backgroundPosition:"center center, center center",backgroundSize:"100% 100%, 80% 80%"};if(a){const h="rgba(0,0,0,0.5)";c.backgroundImage=`linear-gradient(${h}, ${h}), url("${a}")`}return Object.assign(l.style,c),n.appendChild(l),["touchstart","touchend","touchcancel"].forEach(h=>{l.addEventListener(h,u=>u.preventDefault(),{passive:!1})}),l};this.jumpBtnEl=i(14,14,bM),this.jumpBtnEl.addEventListener("touchstart",r=>{r.preventDefault(),this.setInput({jump:!0})},{passive:!1}),this.jumpBtnEl.addEventListener("touchend",r=>{r.preventDefault(),this.setInput({jump:!1})},{passive:!1}),this.jumpBtnEl.addEventListener("touchcancel",r=>{r.preventDefault(),this.setInput({jump:!1})},{passive:!1}),this.flyBtnEl=i(14,94,SM),this.flyBtnEl.addEventListener("touchstart",r=>{r.preventDefault(),this.setInput({toggleFly:!0})},{passive:!1}),this.viewBtnEl=i(14,214,TM),this.viewBtnEl.addEventListener("touchstart",r=>{r.preventDefault(),this.setInput({toggleView:!0})},{passive:!1})}destroyMobileControls(){try{this.joystickManager&&this.joystickManager.destroy&&(this.joystickManager.destroy(),this.joystickManager=null),this.joystickZoneEl?.parentElement&&(this.joystickZoneEl.parentElement.removeChild(this.joystickZoneEl),this.joystickZoneEl=null),this.lookAreaEl?.parentElement&&(this.lookAreaEl.parentElement.removeChild(this.lookAreaEl),this.lookAreaEl=null),this.jumpBtnEl?.parentElement&&(this.jumpBtnEl.parentElement.removeChild(this.jumpBtnEl),this.jumpBtnEl=null),this.flyBtnEl?.parentElement&&(this.flyBtnEl.parentElement.removeChild(this.flyBtnEl),this.flyBtnEl=null),this.viewBtnEl?.parentElement&&(this.viewBtnEl.parentElement.removeChild(this.viewBtnEl),this.viewBtnEl=null),this.lookAreaEl?.removeEventListener("pointerdown",this.onPointerDown),this.lookAreaEl?.removeEventListener("pointermove",this.onPointerMove),this.lookAreaEl?.removeEventListener("pointerup",this.onPointerUp),this.lookAreaEl?.removeEventListener("pointercancel",this.onPointerUp)}catch(t){console.warn("销毁移动端摇杆控制时出错：",t)}}destroy(){this.offAllEvent(),this.player&&(this.player.remove(this.camera),this.scene.remove(this.player)),this.player=null,this.person&&(this.scene.remove(this.person),this.person=null),this.resetControls(),this.visualizer&&(this.scene.remove(this.visualizer),this.visualizer=null),this.collider&&(this.scene.remove(this.collider),this.collider=null),this.destroyMobileControls(),wo=null}}function BM(){wo||(wo=new AM);const s=wo;return{init:(t,e)=>s.init(t,e),changeView:()=>s.changeView(),reset:t=>s.reset(t),update:t=>s.update(t),destroy:()=>s.destroy(),setInput:t=>s.setInput(t),getposition:()=>s.getPosition()}}export{Nl as $,Ou as A,ke as B,Gd as C,$p as D,il as E,wn as F,Dy as G,FM as H,Oe as I,ll as J,al as K,fe as L,ye as M,xi as N,NM as O,tn as P,nn as Q,Cs as R,wM as S,Pl as T,ln as U,D as V,LM as W,Ul as X,Fl as Y,jd as Z,Ll as _,PM as a,bo as a0,Mo as a1,So as a2,vl as a3,gl as a4,ml as a5,pl as a6,fl as a7,dl as a8,hl as a9,Gp as aA,gp as aB,ud as aC,Nt as aD,Pp as aE,ul as aa,Ku as ab,ac,en as ad,hn as ae,ju as af,qu as ag,Ue as ah,Xf as ai,Hu as aj,Ae as ak,rl as al,cl as am,To as an,Dl as ao,Wi as ap,Wn as aq,Ih as ar,UM as as,ue as at,On as au,DM as av,Vp as aw,Ti as ax,yi as ay,Mr as az,Cy as b,Go as c,ce as d,Et as e,Ye as f,pc as g,yr as h,ii as i,Hi as j,Tt as k,Gn as l,Xn as m,Yd as n,IM as o,BM as p,Bt as q,_d as r,he as s,Gt as t,be as u,Ei as v,CM as w,RM as x,dd as y,zn as z};
